...
mm = (('effort', 'effort', 5),
 ...
 ('finger-wag', 'finger-wag', 5))
ds = (('throw-paper', 'throw-paper', 5), ('magic2', 'magic2', 5))
hh = (('pen-squirt', 'fountain-pen', 7),
 ('glower', 'glower', 5),
 ('throw-paper', 'throw-paper', 5),
 ('roll-o-dex', 'roll-o-dex', 5))
cr = (('throw-paper', 'throw-paper', 3.5), ('glower', 'glower', 5), ('pickpocket', 'pickpocket', 5))
tbc = (('glower', 'glower', 5),
 ('cigar-smoke', 'cigar-smoke', 8),
 ('song-and-dance', 'song-and-dance', 8),
 ('golf-club-swing', 'golf-club-swing', 5))
cc = (('phone', 'phone', 3.5), ('watercooler', 'watercooler', 5), ('glower', 'glower', 5))
tm = (('pickpocket', 'pickpocket', 5),
 ('roll-o-dex', 'roll-o-dex', 5),
 ('phone', 'phone', 5))
...
tf = (('glower', 'glower', 5), ('phone', 'phone', 5), ('throw-object', 'throw-object', 5))
...
b = (('effort', 'effort', 5), ('throw-paper', 'throw-paper', 5), ('throw-object', 'throw-object', 5))
dt = (('throw-paper', 'throw-paper', 5), ('finger-wag', 'fingerwag', 5))
