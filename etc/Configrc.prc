...
tt-specific-login 1
# Single-player mode - When enabled, game will attempt to run without external servers
# Currently not fully implemented - server components still required
want-single-player 0
