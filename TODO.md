### Wishlist and Ideas:
    ...
    > Have the daffodil move up and down based on how many players are online. So, if there's one person online, it'll move up to the highest position it can when that one Toon stands next to it.
    ...
    > Update Pets:
        > Make a 3D model of puffles using the eye and mouth texture from Club Penguin
            > Using tutorials, add unique animations for the Puffles that mimick Tricks the Doodles would use.
        > Add more tricks.
        > Type-A-Name for Pets
    > Fix fishing
    > Implement a new Toon Tip system that replaces the one on the loading screen
        > Have Toon Tips appear to you on the side of the screen and you can view them in your Shtiker Book
    > Add more new Fish Species
    ...
    > Allow us to see the sky in the Factory
    > Make the lamps, building, moon, and other stuff emit light during the night and the sun emit light during the day
    > Add the ability to choose what you say to the NPCs to enhance gameplay
    > Add a language button to the Log In Screen
        > Add the major languages including Spanish, French, Portugese, etc.
            > After that's done, add cusom languages like Atlantean, Moorse Code, and so on.
    > Add pupil customizations and colorizations with multi-colored pupils
    ...
    > This update should also add Human Toons stylized towards the game.
