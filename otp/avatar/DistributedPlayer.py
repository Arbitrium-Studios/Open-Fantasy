...
class DistributedPlayer(DistributedAvatar.DistributedAvatar,
    ...
    def arrivedOnDistrict(self, districtId):
        ...
        if hasattr(
                self, 'frameTimeWeArrivedOnDistrict') and curFrameTime == self.frameTimeWeArrivedOnDistrict:
    ...
    def setAccessLevel(self, accessLevel):
        ...
        if self.isLocal():
            self.cr.wantMagicWords = self.accessLevel > OTPGlobals.AccessLevelName2Int.get(
                'NO_ACCESS')
