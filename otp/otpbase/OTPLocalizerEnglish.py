...
ProblemActivatingChat: str = 'Oops!  We were unable to activate the "True Friends" chat feature.\n\n%s\n\nPlease try again later.'
...
FriendSecretIntro = "If you are playing PLAYER ZER0 STUDIO's Toontown Fantasy with someone you know in the real world, you can become True Friends.  You can chat using the keyboard with your True Friends.  Other Toons won't understand what you're saying.\n\nYou do this by getting a True Friend Code.  Tell the True Friend Code to your friend, but not to anyone else.  When your friend types in your True Friend Code on his or her screen, you'll be True Friends in Toontown!"
...
FriendSecretDetermineSecretAccountRollover = 'A friend across the Arbitrium Studios network'
...
SuitBrushOffs: dict[str | None, list[str]] = {'f': ["I'm late for a meeting."],
                                              'p': ['Push off.'],
                                              'ym': ['Yes Man says NO.'],
...
SuitFaceoffTaunts: dict[str, list[str]] = {'b': ['Do you have a donation for me?',
...
SpeedChatStaticTextToontown = {100: 'Hi!',
                               ...
                               30110: 'Mickey is in Flowering Grove.',
                               ...
                               30452: "It's on Oak Street in Flowering Grove."}
