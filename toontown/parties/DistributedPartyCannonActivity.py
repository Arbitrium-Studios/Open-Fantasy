...
class DistributedPartyCannonActivity(DistributedPartyActivity):
    ...
    def load(self):
        ...
        self.sndBounce1 = base.loader.loadSfx('user/resources/default/phase_13/audio/sfx/bounce1.ogg')
        self.sndBounce2 = base.loader.loadSfx('user/resources/default/phase_13/audio/sfx/bounce2.ogg')
        self.sndBounce3 = base.loader.loadSfx('user/resources/default/phase_13/audio/sfx/bounce3.ogg')
        self.onstage()
