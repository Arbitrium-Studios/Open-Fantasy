...
class DistributedParty(DistributedObject.DistributedObject):
    ...
    def load(self):
        ...
        self.defaultSignModel = loader.loadModel(
            '../../user/default/resources/default/phase_13/models/parties/eventSign')
        self.activityIconsModel = loader.loadModel(
            '../../user/default/resources/default/phase_4/models/parties/eventSignIcons')
        model = loader.loadModel('../../user/default/resources/default/phase_4/models/parties/partyStickerbook')
        ...
        self.defaultLeverModel = loader.loadModel(
            '../../user/default/resources/default/phase_13/models/parties/partyLeverBase')
        self.defaultStickModel = loader.loadModel(
            '../../user/default/resources/default/phase_13/models/parties/partyLeverStick')

    def loadGrass(self):
        self.grassRoot = NodePath('GrassRoot')
        self.grassRoot.reparentTo(base.cr.playGame.hood.loader.geom)
        grass = loader.loadModel('../../user/default/resources/default/phase_13/models/parties/grass')
    ...
    def loadPartyCountdownTimer(self):
        self.partyClockModel = loader.loadModel(
            '../../user/default/resources/default/phase_13/models/parties/partyClock')
