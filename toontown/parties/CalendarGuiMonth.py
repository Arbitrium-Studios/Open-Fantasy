...
class CalendarGuiMonth(DirectFrame):
    ...
    def __init__(self, parent, startingDateTime, scale=1.0, pos=(
            0, 0, -0.1), dayClickCallback=None, onlyFutureDaysClickable=False, onlyFutureMonthsClickable=False):
    ...
    def load(self):
        monthAsset = loader.loadModel(
            '../../user/default/resources/default/phase_4/models/parties/tt_m_gui_sbk_calendar')
    ...
    def createGuiObjects(self):
        ...
        def makeLabel(itemName, itemNum, *extraArgs):
            return DirectLabel(text=itemName, frameColor=(
