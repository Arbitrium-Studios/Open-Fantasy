...
class PartyPlanner(DirectFrame, FSM):
    ...
    def setInviteTheme(self, themeNumber):
        ...
        self.selectedInviteThemeLabel['text'] = '%s %s (%d/%d)' % (self.inviteVisual.inviteThemesIdToInfo[self.currentInvitationTheme][1],
                                                                   ...
                                                                   self.inviteThemes.index(
                                                                       self.currentInvitationTheme) + 1,
    ...
    def _createDatePage(self):
        ...
        self.calendarGuiMonth = CalendarGuiMonth(page, curServerDate, scale=0.95, pos=(
            -0.05, 0.0, -0.33), dayClickCallback=self._dayClickCallback, onlyFutureDaysClickable=True)
        return page
    ...
    def alterPartyTime(self, year=None, month=None,
