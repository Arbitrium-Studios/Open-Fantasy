...
class DistributedPartyValentineJukeboxActivity(
    ...
    def load(self):
        ...
        newTexture = loader.loadTexture(
            '../../user/default/resources/default/phase_13/maps/tt_t_ara_pty_jukeboxValentineA.jpg',
            '../../user/default/resources/default/phase_13/maps/tt_t_ara_pty_jukeboxValentineA_a.rgb')
