...
class CarSmoke(NodePath):
    ...
    def __init__(self, parent):
        ...
        if AppRunnerGlobal.appRunner:
            ...
            particleSearchPath.appendDirectory(Filename('../../user/default/resources/default/phase_3.5/etc'))
            particleSearchPath.appendDirectory(Filename('../../user/default/resources/default/phase_4/etc'))
            particleSearchPath.appendDirectory(Filename('../../user/default/resources/default/phase_5/etc'))
            particleSearchPath.appendDirectory(Filename('../../user/default/resources/default/phase_6/etc'))
            particleSearchPath.appendDirectory(Filename('../../user/default/resources/default/phase_7/etc'))
            particleSearchPath.appendDirectory(Filename('../../user/default/resources/default/phase_8/etc'))
            particleSearchPath.appendDirectory(Filename('../../user/default/resources/default/phase_9/etc'))
        ...
        ren.setTextureFromNode(
            '../../user/default/resources/default/phase_4/models/props/tt_m_efx_ext_smoke', '**/*')
