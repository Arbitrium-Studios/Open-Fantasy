...
SFXPATHS = {SFX.poof: '../../user/default/resources/default/phase_4/audio/sfx/firework_distance_02.ogg',
            SFX.magic: '../../user/default/resources/default/phase_4/audio/sfx/SZ_DD_treasure.ogg'}
