...
class MagicWord:
    ...
    def executeWord(self):
        ...
        for avId in self.targets:
            ...
            #         validTargets -= 1
            #         continue
            # return "{} is currently locked. You can only use administrative
            # commands on them.".format(name)
...
class MaxToon(MagicWord):
    ...
    def handleWord(self, invoker, avId, toon, *args):
        ...
        # This is mainly copied from Anesidora just so I can better work on
        # things.
