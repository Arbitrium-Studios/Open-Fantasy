...
Audio.Cutoff = 75.0
Audio.MusicFiles = {'normal': 'user/resources/default/phase_4/audio/bgm/MG_cannon_game.ogg',
                    'end': 'user/resources/default/phase_4/audio/bgm/FF_safezone.ogg',
                    'waiting': 'user/resources/default/phase_4/audio/bgm/m_match_bg2.ogg',
                    'invul': 'user/resources/default/phase_4/audio/bgm/MG_CogThief.ogg',
                    'timeRunningOut': 'user/resources/default/phase_7/audio/bgm/encntr_suit_winning_indoor.ogg'}
Audio.SfxFiles = {'propeller': 'user/resources/default/phase_4/audio/sfx/TB_propeller.ogg',
                  'propeller_damaged': 'user/resources/default/phase_5/audio/sfx/tt_s_ara_cfg_propellers_damaged.ogg',
                  'fan': 'user/resources/default/phase_4/audio/sfx/target_wind_float_loop.ogg',
                  'getMemo': 'user/resources/default/phase_4/audio/sfx/MG_maze_pickup.ogg',
                  'getLaff': 'user/resources/default/phase_4/audio/sfx/avatar_emotion_laugh.ogg',
                  'getRedTape': 'user/resources/default/phase_5/audio/sfx/SA_red_tape.ogg',
                  'invulBuff': 'user/resources/default/phase_4/audio/sfx/ring_get.ogg',
                  'invulDebuff': 'user/resources/default/phase_4/audio/sfx/ring_miss.ogg',
                  'refuel': 'user/resources/default/phase_5/audio/sfx/LB_receive_evidence.ogg',
                  'bladeBreak': 'user/resources/default/phase_5/audio/sfx/tt_s_ara_cfg_propellerBreaks.ogg',
                  'popupHelpText': 'user/resources/default/phase_3/audio/sfx/GUI_balloon_popup.ogg',
                  'collide': 'user/resources/default/phase_3.5/audio/sfx/AV_collision.ogg',
                  'whirlwind': 'user/resources/default/phase_5/audio/sfx/tt_s_ara_cfg_whirlwind.ogg',
                  'toonInWhirlwind': 'user/resources/default/phase_5/audio/sfx/tt_s_ara_cfg_toonInWhirlwind.ogg',
                  'death': 'user/resources/default/phase_5/audio/sfx/tt_s_ara_cfg_toonFalls.ogg',
                  'legalEagleScream': 'user/resources/default/phase_5/audio/sfx/tt_s_ara_cfg_eagleCry.ogg',
                  'toonHit': 'user/resources/default/phase_5/audio/sfx/tt_s_ara_cfg_toonHit.ogg',
                  'lose': 'user/resources/default/phase_4/audio/sfx/MG_lose.ogg',
                  'win': 'user/resources/default/phase_4/audio/sfx/MG_win.ogg',
                  'refuelSpin': 'user/resources/default/phase_4/audio/sfx/clock12.ogg',
