    ...
    def __playElevator(self, ts, name, callback):
        ...
        if self.isBossFloor(self.currentFloor):
            ...
            self.floorModel = loader.loadModel(
                '../../user/default/resources/default/phase_5/models/cogdominium/tt_m_ara_crg_penthouse')
            ...
            if self.FOType:
                ...
                for i in range(4):
                    paintingModel = loader.loadModel(
                        '../../user/default/resources/default/phase_5/models/cogdominium/%s' % paintingModelName)
    ...
    def displayBadges(self):
        ...
        for player in range(len(self.toons)):
            goldBadge = loader.loadModel(
                '../../user/default/resources/default/phase_5/models/cogdominium/tt_m_ara_crg_goldTrophy')
            ...
            for floor in range(numFloors):
                silverBadge = loader.loadModel(
                    '../../user/default/resources/default/phase_5/models/cogdominium/tt_m_ara_crg_silverTrophy.bam')
