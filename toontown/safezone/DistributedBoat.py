...
class DistributedBoat(DistributedObject.DistributedObject):
    ...
    def __init__(self, cr):
        ...
        self.fsm = ClassicFSM.ClassicFSM('DistributedBoat', [State.State('off', self.enterOff, self.exitOff, ['DockedEast',
                                                                                                              ...
                                                                                                              'SailingEast']),
                                                             State.State(
            'DockedEast', self.enterDockedEast, self.exitDockedEast, [
                'SailingWest', 'SailingEast', 'DockedWest']),
            State.State(
            'SailingWest', self.enterSailingWest, self.exitSailingWest, [
    ...
    def setupTracks(self):
        ...
        self.eastWestMopath.loadFile('../../user/default/resources/default/phase_6/paths/dd-e-w')
        ...
        self.westEastMopath.loadFile('../../user/default/resources/default/phase_6/paths/dd-w-e')
