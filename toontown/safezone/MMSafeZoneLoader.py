...
class MMSafeZoneLoader(SafeZoneLoader.SafeZoneLoader):
    ...
    def __init__(self, hood, parentFSM, doneEvent):
        ...
        self.musicFile = '../../user/default/resources/default/phase_6/audio/bgm/MM_nbrhood.ogg'
        self.activityMusicFile = '../../user/default/resources/default/phase_6/audio/bgm/MM_SZ_activity.ogg'
        self.dnaFile = '../../user/default/resources/default/phase_6/dna/minnies_melody_land_sz.dna'
        self.safeZoneStorageDNAFile = '../../user/default/resources/default/phase_6/dna/storage_MM_sz.dna'
