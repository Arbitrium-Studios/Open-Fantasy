...
class DistributedButterfly(DistributedObject.DistributedObject):
            ...
            'DistributedButterfly', [
                State.State(
                    'off', self.enterOff, self.exitOff, [
                        'Flying', 'Landed']), State.State(
                    'Flying', self.enterFlying, self.exitFlying, ['Landed']), State.State(
                        'Landed', self.enterLanded, self.exitLanded, ['Flying'])], 'off', 'off')
        self.butterfly = None
    ...
    def generate(self):
        ...
        self.butterfly.loadModel('../../user/default/resources/default/phase_4/models/props/SZ_butterfly-mod.bam')
        self.butterfly.loadAnims({'flutter': '../../user/default/resources/default/phase_4/models/props/SZ_butterfly-flutter.bam',
                                  'glide': '../../user/default/resources/default/phase_4/models/props/SZ_butterfly-glide.bam',
                                  'land': '../../user/default/resources/default/phase_4/models/props/SZ_butterfly-land.bam'})
