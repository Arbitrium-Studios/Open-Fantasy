...
class ToontownLoadingScreen:
    ...
    def __init__(self):
        ...
        self.__count = 0
        self.gui = loader.loadModel('../../user/default/resources/default/phase_3/models/gui/progress-background')
        self.banner = loader.loadModel(
            '../../user/default/resources/default/phase_3/models/gui/toon_council').find('**/scroll')
