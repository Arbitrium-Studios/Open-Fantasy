...
class ToontownLoadingBlocker(TTDialog.TTDialog):
    ...
    def __init__(self, avList):
        ...
        gui = loader.loadModel('../../user/default/resources/default/phase_3/models/gui/tt_m_gui_pat_mainGui')
        ...
        if self.__isValidDownloadBar():
            ...
            self.hideBlockerIval = Sequence(
                shrinkIval, Wait(0.5), Func(
                    self.__hideBlocker), Func(
                    self.__resetLoadingBar), Func(
                    self.destroy))
