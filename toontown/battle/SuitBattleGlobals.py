...
class SuitAttack:
    ...
    def __init__(self, name: str, /, *, hp: tuple[int, ...], acc: tuple[int, ...], freq: tuple[int, ...], effects: tuple[StatusEffects.StatusEffect, ...] = (), targets: Targeting) -> None:
        '''
        Parameters:
            ...
            targets (Targeting): Who will be affected by the attack.
        '''
        ...
        if not isinstance(effects, tuple):
            raise TypeError
        if not isinstance(targets, Targeting):
            raise TypeError
        self.name: str = name
        ...
        self.targets: Targeting = targets
