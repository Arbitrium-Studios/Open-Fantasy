...
import random
Props: tuple[tuple[int | float, str, str] | tuple[int | float, str, str, str], ...] = ((5, 'partyBall', 'partyBall'),
                                                                                       (5,
                                                                                        'feather',
                                                                                        'feather-mod',
                                                                                        'feather-chan'),
...
class PropPool:
    ...
    def getPath(self, phase: int | float, model: str) -> str:
        return 'phase_{}/models/props/{}'.format(phase, model)

    def makeVariant(self, name) -> None:
        if name == 'tart':
    ...
    def storeProp(self, name, prop) -> None:
...
globalPropPool: PropPool = PropPool()
