...
def __throwPie(throw, delay, hitCount, showCannon=1):
    ...
    if showCannon:
        ...
        cannon = loader.loadModel('../../user/default/resources/default/phase_4/models/minigames/toon_cannon')
        ...
        smoke = loader.loadModel('../../user/default/resources/default/phase_4/models/props/test_clouds')
        ...
        soundCogPanic = base.loader.loadSfx(
            '../../user/default/resources/default/phase_5/audio/sfx/ENC_cogafssm.ogg')
