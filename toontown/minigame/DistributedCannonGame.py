...
class DistributedCannonGame(DistributedMinigame):
    ...
    def load(self):
        ...
        self.tower = loader.loadModel(
            '../../user/default/resources/default/phase_4/models/minigames/toon_cannon_water_tower')
        ...
        self.hill = loader.loadModel('../../user/default/resources/default/phase_4/models/minigames/cannon_hill')
    ...
    def __spawnCameraLookAtLerp(self, targetPos, targetLookAt, duration):
        ...
        self.introCameraSeq = camera.posQuatInterval(
            duration,
            Point3(targetPos),
            targetQuat,
            blendType='easeInOut',
