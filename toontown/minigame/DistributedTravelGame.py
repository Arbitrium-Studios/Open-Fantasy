...
class DistributedTravelGame(DistributedMinigame):
    ...
    def __init__(self, cr):
        ...
        self.gameFSM = ClassicFSM.ClassicFSM('DistributedTravelGame', [State.State('off', self.enterOff, self.exitOff, ['inputChoice']),
            ...
            State.State(
            'moveTrolley', self.enterMoveTrolley, self.exitMoveTrolley, [
        ...
        self.turntableRotateSfx = base.loader.loadSfx(
            '../../user/default/resources/default/phase_4/audio/sfx/MG_sfx_travel_game_turntble_rotate_2.ogg')
        self.wonGameSfx = base.loader.loadSfx(
            '../../user/default/resources/default/phase_4/audio/sfx/MG_sfx_travel_game_bonus.ogg')
        self.lostGameSfx = base.loader.loadSfx(
            '../../user/default/resources/default/phase_4/audio/sfx/MG_sfx_travel_game_no_bonus_2.ogg')
        self.noWinnerSfx = base.loader.loadSfx(
            '../../user/default/resources/default/phase_4/audio/sfx/MG_sfx_travel_game_no_bonus.ogg')
        self.boardIndex = 0
        self.avNames = []
    ...
    def load(self):
        ...
        self.gameBoard = loader.loadModel(
            '../../user/default/resources/default/phase_4/models/minigames/toon_cannon_gameground')
        self.gameBoard.setPosHpr(100, 0, 0, 0, 0, 0)
        self.gameBoard.setScale(1.0)
        station = loader.loadModel(
            '../../user/default/resources/default/phase_4/models/modules/trolley_station_TT.bam')
        ...
        turnTable = loader.loadModel(
            '../../user/default/resources/default/phase_4/models/minigames/trolley_game_turntable')
        ...
        self.music = base.loader.loadMusic('../../user/default/resources/default/phase_4/audio/bgm/MG_Travel.ogg')
    ...
    def loadGui(self):
        ...
        self.votesPeriodLabel = DirectLabel(
            ...
            relief=None,
            text_align=TextNode.ALeft)
        self.votesToGoLabel = DirectLabel(text=TTLocalizer.TravelGameVotesToGo, parent=self.choiceFrame, pos=(
            -0.21, 0, -0.01), text_scale=TTLocalizer.DTGvotesToGoLabel, relief=None, text_align=TextNode.ALeft)
    ...
    def setServerChoices(self, votes, directions,
                         directionToGo, directionReason):
        if not self.hasLocalToon:
            return
        self.notify.debug(
    ...
    def loadMinigameIcons(self):
        self.mg_icons = loader.loadModel('../../user/default/resources/default/phase_4/models/minigames/mg_icons')
            ...
            if avId == self.localAvId:
                ...
                if labelPos:
                    ...
                    bonusStr = TTLocalizer.TravelGameBonusBeans % {
                        'numBeans': beans}
                    label = DirectLabel(
                        text=bonusStr, relief=None, scale=0.1, pos=labelPos, text_fg=(
                            1.0, 1.0, 1.0, 1.0), text_align=TextNode.ALeft)
                    label.hide()
