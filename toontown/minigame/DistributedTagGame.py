...
class DistributedTagGame(DistributedMinigame):
    ...
    def load(self):
        ...
        self.ground = loader.loadModel('../../user/default/resources/default/phase_4/models/minigames/tag_arena')
        self.music = base.loader.loadMusic('../../user/default/resources/default/phase_4/audio/bgm/MG_toontag.ogg')
        self.tagSfx = base.loader.loadSfx('../../user/default/resources/default/phase_4/audio/sfx/MG_Tag_C.ogg')
        self.itPointer = loader.loadModel(
            '../../user/default/resources/default/phase_4/models/minigames/bboard-pointer')
        self.tracks = []
        self.IT = None
        return
