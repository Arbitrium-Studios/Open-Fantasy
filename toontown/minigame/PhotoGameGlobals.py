...
AREA_DATA[ToontownGlobals.ToontownDocks] = {}
AREA_DATA[ToontownGlobals.ToontownDocks]['FILMCOUNT'] = 28
AREA_DATA[ToontownGlobals.ToontownDocks]['TIME'] = 110
AREA_DATA[ToontownGlobals.ToontownDocks]['CAMERA_INTIAL_POSTION'] = Point3(
    0, 50, 20)
AREA_DATA[ToontownGlobals.ToontownDocks]['DNA_TRIO'] = (
    'phase_6/dna/storage_DD_sz.dna', 'phase_6/dna/storage_DD.dna', 'phase_6/dna/donalds_dock_sz.dna')
AREA_DATA[ToontownGlobals.ToontownDocks]['TRIPOD_OFFSET'] = Point3(0, -4.0, 9.0)
AREA_DATA[ToontownGlobals.ToontownDocks]['START_HPR'] = Point3(
    218.211, -6.7879, 0)
AREA_DATA[ToontownGlobals.ToontownDocks]['PATHS'] = ([Point3(-115.6, 39.4, 5.692),
...
AREA_DATA[ToontownGlobals.ToontownDocks]['PATHANIMREL'] = (0,
                                                         0,
                                                         1,
                                                         2,
                                                         3)
AREA_DATA[ToontownGlobals.ToontownDocks]['ANIMATIONS'] = ([('wave', 2.0), (None, 1.0)],
                                                        [('slip-forward', 2.0),
                                                         (None, 1.0), (None, 1.0)],
                                                        [('shrug', 2.0),
                                                         (None, 1.0)],
                                                        [(None, 1.0)])
AREA_DATA[ToontownGlobals.ToontownDocks]['MOVEMODES'] = ([('walk', 1.0)],
                                                       [('run', 0.4)],
                                                       [('walk', 1.0),
                                                        ('sad-walk', 2.5)],
                                                       [('swim', 1.0)])
