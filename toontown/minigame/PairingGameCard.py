...
class PairingGameCard(PlayingCardNodePath):
    ...
    def load(self):
        oneCard = loader.loadModel(
            '../../user/default/resources/default/phase_4/models/minigames/garden_sign_memory')
        ...
        self.turnUpSound = base.loader.loadSfx(
            '../../user/default/resources/default/phase_4/audio/sfx/MG_pairing_card_flip_face_up.ogg')
        self.turnDownSound = base.loader.loadSfx(
            '../../user/default/resources/default/phase_4/audio/sfx/MG_pairing_card_flip_face_down.ogg')
        return
