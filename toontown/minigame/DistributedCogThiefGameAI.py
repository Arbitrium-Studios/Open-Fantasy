...
class DistributedCogThiefGameAI(DistributedMinigameAI.DistributedMinigameAI):
    ...
    def makeCogCarryBarrel(self, timestamp, clientStamp,
    ...
    def d_makeCogCarryBarrel(
            self, timestamp, clientStamp, cogIndex, barrelIndex):
    ...
    def makeCogDropBarrel(self, timestamp, clientStamp,
                          cogIndex, barrelIndex, barrelPos):
        if cogIndex in self.cogInfo and barrelIndex in self.barrelInfo:
    ...
    def b_makeCogDropBarrel(self, clientStamp, cogIndex,
    ...
    def d_makeCogDropBarrel(self, timestamp, clientStamp,
                            cogIndex, barrelIndex, barrelPos):
        pos = barrelPos
        gameTime = self.getCurrentGameTime()
    ...
    def runAway(self, clientStamp, cogIndex, cogPos,
                barrelIndex, returnPosIndex):
