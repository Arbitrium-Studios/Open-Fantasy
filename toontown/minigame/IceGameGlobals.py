...
NumTreasures = {ToontownGlobals.ToontownPlaza: 2,
                ToontownGlobals.ToontownsShipyard: 2,
...
NumPenalties = {ToontownGlobals.ToontownPlaza: 0,
...
Obstacles = {ToontownGlobals.ToontownPlaza: (),
             ToontownGlobals.ToontownsShipyard: ((0, 0),),
...
ObstacleShapes = {ToontownGlobals.ToontownPlaza: True,
                  ToontownGlobals.ToontownsShipyard: True,
