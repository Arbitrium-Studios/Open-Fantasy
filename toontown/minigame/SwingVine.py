...
class SwingVine(NodePath):
    ...
    def __init__(self, vineIndex, x, y, z, length=20,
                 baseAngle=40, period=4, spiderPeriod=0):
    ...
    def setupCable(self):
        ...
        myTexture = loader.loadTexture('../../user/default/resources/default/phase_4/maps/swinging_vine.jpg')
        gameAssets = loader.loadModel('../../user/default/resources/default/phase_4/models/minigames/vine_game')
