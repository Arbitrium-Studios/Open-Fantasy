...
class DistributedPhotoGame(DistributedMinigame, PhotoGameBase.PhotoGameBase):
    ...
    def load(self):
        ...
        self.filmImage = loader.loadModel(
            '../../user/default/resources/default/phase_4/models/minigames/photogame_filmroll')
        self.filmImage.reparentTo(hidden)
        self.tripodModel = loader.loadModel(
            '../../user/default/resources/default/phase_4/models/minigames/toon_cannon')
        ...
        self.music = base.loader.loadMusic(
            '../../user/default/resources/default/phase_4/audio/bgm/MG_cannon_game.ogg')
        ...
        self.sndFilmTick = base.loader.loadSfx(
            '../../user/default/resources/default/phase_4/audio/sfx/Photo_instamatic.ogg')
        ...
        viewfinderImage = loader.loadModel(
            '../../user/default/resources/default/phase_4/models/minigames/photo_game_viewfinder')
        ...
        self.addSound('zoom', 'Photo_zoom.ogg', '../../user/default/resources/default/phase_4/audio/sfx/')
        self.addSound('snap', 'Photo_shutter.ogg', '../../user/default/resources/default/phase_4/audio/sfx/')
        return
    ...
    def makeAssignmentPanel(self, assignment):
        ...
        starImage = loader.loadModel('../../user/default/resources/default/phase_4/models/minigames/photogame_star')
    ...
    def makeAssignmentFrame(self):
        ...
        photoImage = loader.loadModel(
            '../../user/default/resources/default/phase_4/models/minigames/photo_game_pictureframe')
        size = 1.0
    ...
    def makeScoreFrame(self):
        ...
        scoreImage = loader.loadModel(
            '../../user/default/resources/default/phase_4/models/minigames/photogame_camera')
    ...
    def constructDD(self):
        ...
        self.sky = loader.loadModel('../../user/default/resources/default/phase_3.5/models/props/BR_sky')
        self.sky.reparentTo(render)
        self.sky.setBin('background', -100)
    ...
    def constructMM(self):
        ...
        self.sky = loader.loadModel('../../user/default/resources/default/phase_6/models/props/MM_sky')
        self.sky.reparentTo(render)
        self.sky.setBin('background', -100)
        self.scene.reparentTo(render)
    ...
    def constructDL(self):
        ...
        self.sky = loader.loadModel('../../user/default/resources/default/phase_8/models/props/DL_sky')
        self.sky.reparentTo(render)
        self.sky.setBin('background', -100)
        self.scene.reparentTo(render)
        self.scene.find('**/door_trigger_8*').hide()
