...
class DistributedCatchGame(DistributedMinigame):
    ...
    def load(self):
        ...
        groundModels = ['../../user/default/resources/default/phase_4/models/minigames/treehouse_2players',
                        '../../user/default/resources/default/phase_4/models/minigames/treehouse_2players',
                        '../../user/default/resources/default/phase_4/models/minigames/treehouse_3players',
                        '../../user/default/resources/default/phase_4/models/minigames/treehouse_4players']
        index = self.getNumPlayers() - 1
        self.ground = loader.loadModel(groundModels[index])
        self.ground.setHpr(180, -90, 0)
        self.dropShadow = loader.loadModel('../../user/default/resources/default/phase_3/models/props/drop_shadow')
        self.dropObjModels = {}
        ...
        self.sndPerfect = base.loader.loadSfx(
            '../../user/default/resources/default/phase_4/audio/sfx/ring_perfect.ogg')
        self.toonSDs = {}
        avId = self.localAvId
    ...
    def calcDifficultyConstants(self, difficulty, numPlayers):
        ...
        self.SuitPeriodRange = [
            lerp(
                5.0, 3.0, self.getDifficulty()), lerp(
                15.0, 8.0, self.getDifficulty())]
    ...
    def defineConstants(self):
        ...
        dropGridDimensions = [[5, 5],
                              ...
                              [6, 6],
                              [7, 7]]
        self.DropRows, self.DropColumns = dropGridDimensions[self.getNumPlayers(
        ) - 1]
        self.cameraPosTable = [[0, -29.36, 28.17]] * \
            2 + [[0, -32.87, 30.43], [0, -35.59, 32.1]]
    ...
    def getDropIval(self, x, y, dropObjName, num):
        ...
        self.accept(
            catchEventName, Functor(
                eatCollEntry, Functor(
                    self.__handleCatch, num)))

        def cleanup(self=self, dropNode=dropNode,
                    num=num, event=catchEventName):
            self.ignore(event)
            dropNode.removeNode()
