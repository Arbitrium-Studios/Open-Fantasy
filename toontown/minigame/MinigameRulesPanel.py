...
class MinigameRulesPanel(StateData.StateData):
    ...
    def __init__(self, panelName, gameTitle, instructions,
                 doneEvent, timeout=MinigameGlobals.rulesDuration):
    ...
    def load(self):
        minigameGui = loader.loadModel('../../user/default/resources/default/phase_4/models/gui/minigame_rules_gui')
        buttonGui = loader.loadModel('../../user/default/resources/default/phase_3.5/models/gui/inventory_gui')
