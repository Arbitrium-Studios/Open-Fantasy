...
CameraStartingPosition = (-28,
                          ...
                          0,
                          0)
GameDuration = {ToontownGlobals.ToontropolisCenter: 150,
...
BaseBonusOnCompletion = {ToontownGlobals.ToontropolisCenter: 15,
...
ScoreLossPerEnemyCollision = {ToontownGlobals.ToontropolisCenter: -1,
...
ScoreLossPerFallDown = {ToontownGlobals.ToontropolisCenter: -0,
...
ScoreLossPerStomperSquish = {ToontownGlobals.ToontropolisCenter: -1,
                             ToontownGlobals.ToontropolisDocks: -1,
                             ToontownGlobals.FloweringGrove: -1,
                             ToontownGlobals.TheLandOfMusic: -1,
                             ToontownGlobals.TundraWonderland: -1,
                             ToontownGlobals.TwilightDreamland: -1}
SectionWeights = {ToontownGlobals.ToontropolisCenter: ((0, 25),
                                                    (1, 25),
                                                    (2, 25),
                                                    (3, 15),
                                                    (4, 10),
                                                    (5, 0)),
                  ToontownGlobals.ToontropolisDocks: ((0, 15),
                                                (1, 25),
                                                (2, 25),
                                                (3, 15),
                                                (4, 10),
                  ...
                  ToontownGlobals.TwilightDreamland: ((0, 10),
                                                     ...
                                                     (4, 25),
                                                     (5, 25))}
NumSections = {ToontownGlobals.ToontropolisCenter: 5,
...
PercentMaxEnemies = {ToontownGlobals.ToontropolisCenter: 50,
...
PercentMaxTreasures = {ToontownGlobals.ToontropolisCenter: 100,
                       ...
                       ToontownGlobals.TwilightDreamland: 100}
PercentMaxSpawnPoints = {ToontownGlobals.ToontropolisCenter: 100,
...
PercentMaxStompers = {ToontownGlobals.ToontropolisCenter: 50,
                      ToontownGlobals.ToontropolisDocks: 60,
                      ToontownGlobals.FloweringGrove: 70,
                      ToontownGlobals.TheLandOfMusic: 80,
                      ToontownGlobals.TundraWonderland: 90,
