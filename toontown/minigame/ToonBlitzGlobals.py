...
CameraStartingPosition = (-28,
                          ...
                          0,
                          0)
GameDuration = {ToontownGlobals.ToontownCenter: 150,
                ToontownGlobals.ToontownShipyards: 145,
...
BaseBonusOnCompletion = {ToontownGlobals.ToontownCenter: 15,
                         ToontownGlobals.ToontownShipyards: 17,
...
ScoreLossPerEnemyCollision = {ToontownGlobals.ToontownCenter: -1,
...
ScoreLossPerFallDown = {ToontownGlobals.ToontownCenter: -0,
                        ToontownGlobals.ToontownShipyards: -0,
...
ScoreLossPerStomperSquish = {ToontownGlobals.ToontownCenter: -1,
                             ToontownGlobals.ToontownShipyards: -1,
                             ToontownGlobals.FloweringGrove: -1,
                             ToontownGlobals.TheLandOfMusic: -1,
                             ToontownGlobals.TundraWonderland: -1,
                             ToontownGlobals.TwilightDreamland: -1}
SectionWeights = {ToontownGlobals.ToontownCenter: ((0, 25),
                                                    (1, 25),
                                                    (2, 25),
                                                    (3, 15),
                                                    (4, 10),
                                                    (5, 0)),
                  ToontownGlobals.ToontownShipyards: ((0, 15),
                                                (1, 25),
                                                (2, 25),
                                                (3, 15),
                                                (4, 10),
                                                (5, 10)),
                  ToontownGlobals.FloweringGrove: ((0, 15),
                                                 (1, 15),
                                                 (2, 25),
                                                 (3, 25),
                                                 (4, 10),
                                                 (5, 10)),
                  ToontownGlobals.TheLandOfMusic: ((0, 10),
                                                      (1, 10),
                                                      (2, 25),
                                                      (3, 25),
                                                      (4, 15),
                                                      (5, 15)),
                  ToontownGlobals.TundraWonderland: ((0, 10),
                                              (1, 10),
                                              (2, 15),
                                              (3, 25),
                                              (4, 25),
                  ...
                  ToontownGlobals.TwilightDreamland: ((0, 10),
                                                     ...
                                                     (4, 25),
                                                     (5, 25))}
NumSections = {ToontownGlobals.ToontownCenter: 5,
               ToontownGlobals.ToontownShipyards: 5,
...
PercentMaxEnemies = {ToontownGlobals.ToontownCenter: 50,
                     ToontownGlobals.ToontownShipyards: 60,
...
PercentMaxTreasures = {ToontownGlobals.ToontownCenter: 100,
                       ToontownGlobals.ToontownShipyards: 100,
                       ToontownGlobals.FloweringGrove: 100,
                       ToontownGlobals.TheLandOfMusic: 100,
                       ToontownGlobals.TundraWonderland: 100,
                       ToontownGlobals.TwilightDreamland: 100}
PercentMaxSpawnPoints = {ToontownGlobals.ToontownCenter: 100,
                         ToontownGlobals.ToontownShipyards: 90,
...
PercentMaxStompers = {ToontownGlobals.ToontownCenter: 50,
                      ToontownGlobals.ToontownShipyards: 60,
                      ToontownGlobals.FloweringGrove: 70,
                      ToontownGlobals.TheLandOfMusic: 80,
                      ToontownGlobals.TundraWonderland: 90,
...
TreasureList11 = [[(4, 0, 34)],
                  ...
                  [(140, 0, 34)],
                  [(162, 0, 34)]]
EnemyList11 = [['cc', [(26, 0, 12.75), (46, 0, 12.75), 3.5]], ['tm', [(
    74, 0, 6), (94, 0, 6), 3.5]], ['sc', [(122, 0, 19.5), (142, 0, 19.5), 3.5]]]
...
EnemyList4 = [['cc', [(26, 0, 12.75), (46, 0, 12.75), 3.5]], ['tm', [(
    74, 0, 6), (94, 0, 6), 3.5]], ['sc', [(122, 0, 19.5), (142, 0, 19.5), 3.5]]]
