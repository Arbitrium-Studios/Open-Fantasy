...
CameraStartingPosition = (-28,
                          ...
                          0,
                          0)
GameDuration = {ToontownGlobals.ToontownPlaza: 150,
                ToontownGlobals.ToontownsShipyard: 145,
...
BaseBonusOnCompletion = {ToontownGlobals.ToontownPlaza: 15,
                         ToontownGlobals.ToontownsShipyard: 17,
...
ScoreLossPerEnemyCollision = {ToontownGlobals.ToontownPlaza: -1,
...
ScoreLossPerFallDown = {ToontownGlobals.ToontownPlaza: -0,
                        ToontownGlobals.ToontownsShipyard: -0,
...
ScoreLossPerStomperSquish = {ToontownGlobals.ToontownPlaza: -1,
                             ToontownGlobals.ToontownsShipyard: -1,
                             ToontownGlobals.FloweringGrove: -1,
                             ToontownGlobals.TheLandOfMusic: -1,
                             ToontownGlobals.TundraWonderland: -1,
                             ToontownGlobals.TwilightDreamland: -1}
SectionWeights = {ToontownGlobals.ToontownPlaza: ((0, 25),
                                                    (1, 25),
                                                    (2, 25),
                                                    (3, 15),
                                                    (4, 10),
                                                    (5, 0)),
                  ToontownGlobals.ToontownsShipyard: ((0, 15),
                                                (1, 25),
                                                (2, 25),
                                                (3, 15),
                                                (4, 10),
                  ...
                  ToontownGlobals.TwilightDreamland: ((0, 10),
                                                     ...
                                                     (4, 25),
                                                     (5, 25))}
NumSections = {ToontownGlobals.ToontownPlaza: 5,
               ToontownGlobals.ToontownsShipyard: 5,
...
PercentMaxEnemies = {ToontownGlobals.ToontownPlaza: 50,
                     ToontownGlobals.ToontownsShipyard: 60,
...
PercentMaxTreasures = {ToontownGlobals.ToontownPlaza: 100,
                       ToontownGlobals.ToontownsShipyard: 100,
                       ToontownGlobals.FloweringGrove: 100,
                       ToontownGlobals.TheLandOfMusic: 100,
                       ToontownGlobals.TundraWonderland: 100,
                       ToontownGlobals.TwilightDreamland: 100}
PercentMaxSpawnPoints = {ToontownGlobals.ToontownPlaza: 100,
                         ToontownGlobals.ToontownsShipyard: 90,
...
PercentMaxStompers = {ToontownGlobals.ToontownPlaza: 50,
                      ToontownGlobals.ToontownsShipyard: 60,
                      ToontownGlobals.FloweringGrove: 70,
                      ToontownGlobals.TheLandOfMusic: 80,
                      ToontownGlobals.TundraWonderland: 90,
