...
SectionWeights = {ToontownGlobals.ToontownCentral: ((0, 25),
                                                    ...
                                                    (4, 10),
                                                    (5, 0)),
                  ToontownGlobals.ToontownDocks: ((0, 15),
                                                (1, 25),
                                                (2, 25),
                                                (3, 15),
                                                (4, 10),
                  ...
                  ToontownGlobals.TundraWonderland: ((0, 10),
                                              ...
                                              (4, 25),
                                              (5, 15)),
                  ToontownGlobals.TwlightDreamland: ((0, 10),
                                                     (1, 10),
                                                     (2, 15),
                                                     (3, 15),
                                                     (4, 25),
