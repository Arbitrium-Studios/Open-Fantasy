...
class MazeBase:
    ...
    def isWalkable(self, tX, tY, rejectList=()):
        if tX <= 0 or tY <= 0 or tX >= self.width or tY >= self.height:
            return 0
        return not self.collisionTable[tY][tX] and not self.collisionTable[tY - 1][tX] and not self.collisionTable[tY][tX -
                                                                                                                       1] and not self.collisionTable[tY - 1][tX - 1] and (tX, tY) not in rejectList
