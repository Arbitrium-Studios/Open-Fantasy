...
CourseSections = (((20,
                  ...
                  ((15,
                   ...
                   (20,
                      ...
                      5,
                      0)))
CourseWeights = {ToontownGlobals.ToontropolisCenter: ((0, 25),
                                                   (1, 25),
                                                   (2, 25),
                                                   (3, 25)),
                 ToontownGlobals.ToontropolisDocks: ((1, 25),
                                               (2, 25),
                                               (3, 25),
                                               (4, 25)),
                 ...
                 ToontownGlobals.TwilightDreamland: ((4, 20),
                                                    ...
                                                    (7, 20),
                                                    (8, 20))}
BaseBonusOnEndVine = {ToontownGlobals.ToontropolisCenter: 4,
...
BatInfo = {ToontownGlobals.ToontropolisCenter: ((60, 0, 0.35),),
...
SpiderLimits = {ToontownGlobals.ToontropolisCenter: 1,
