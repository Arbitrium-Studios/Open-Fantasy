...
CourseSections = (((20,
                  ...
                  ((15,
                   ...
                   (20,
                      ...
                      5,
                      0)))
CourseWeights = {ToontownGlobals.ToontownCenter: ((0, 25),
                                                   (1, 25),
                                                   (2, 25),
                                                   (3, 25)),
                 ToontownGlobals.ToontownShipyards: ((1, 25),
                                               (2, 25),
                                               (3, 25),
                                               (4, 25)),
                 ...
                 ToontownGlobals.TwilightDreamland: ((4, 20),
                                                    ...
                                                    (7, 20),
                                                    (8, 20))}
BaseBonusOnEndVine = {ToontownGlobals.ToontownCenter: 4,
...
BatInfo = {ToontownGlobals.ToontownCenter: ((60, 0, 0.35),),
           ToontownGlobals.ToontownShipyards: ((60, 0, 0.25), (30, 30)),
...
SpiderLimits = {ToontownGlobals.ToontownCenter: 1,
