...
CourseSections = (((20,
                  ...
                  ((15,
                   ...
                   (20,
                      ...
                      5,
                      0)))
CourseWeights = {ToontownGlobals.ToontownPlaza: ((0, 25),
                                                   (1, 25),
                                                   (2, 25),
                                                   (3, 25)),
                 ToontownGlobals.ToontownsShipyard: ((1, 25),
                                               (2, 25),
                                               (3, 25),
                                               (4, 25)),
                 ToontownGlobals.FloweringGrove: ((2, 25),
                                                (3, 25),
                                                (4, 25),
                                                (5, 25)),
                 ToontownGlobals.TheLandOfMusic: ((3, 25),
                                                     (4, 25),
                                                     (5, 25),
                                                     (6, 25)),
                 ToontownGlobals.TundraWonderland: ((4, 25),
                                             (5, 25),
                                             (6, 25),
                                             (7, 25)),
                 ToontownGlobals.TwilightDreamland: ((4, 20),
                                                    ...
                                                    (7, 20),
                                                    (8, 20))}
BaseBonusOnEndVine = {ToontownGlobals.ToontownPlaza: 4,
...
BatInfo = {ToontownGlobals.ToontownPlaza: ((60, 0, 0.35),),
           ToontownGlobals.ToontownsShipyard: ((60, 0, 0.25), (30, 30)),
...
SpiderLimits = {ToontownGlobals.ToontownPlaza: 1,
