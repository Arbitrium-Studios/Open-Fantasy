...
class DistributedCogThiefGame(DistributedMinigame):
    ...
    def load(self):
        ...
        self.music = base.loader.loadMusic('../../user/default/resources/default/phase_4/audio/bgm/MG_CogThief.ogg')
        self.initCogInfo()
        for barrelIndex in range(CTGG.NumBarrels):
            barrel = loader.loadModel(
                '../../user/default/resources/default/phase_4/models/minigames/cogthief_game_gagTank')
        ...
        self.gameBoard = loader.loadModel(
            '../../user/default/resources/default/phase_4/models/minigames/cogthief_game')
