...
class ToonBlitzAssetMgr(DirectObject):
    ...
    def load(self):
        ...
        self.background = loader.loadModel(
            '../../user/default/resources/default/phase_4/models/minigames/toonblitz_game')
        self.background.reparentTo(self.world)
        self.startingWall = loader.loadModel(
            '../../user/default/resources/default/phase_4/models/minigames/toonblitz_game_wall')
        self.startingPipe = loader.loadModel(
            '../../user/default/resources/default/phase_4/models/minigames/toonblitz_game_start')
        self.exitElevator = loader.loadModel(
            '../../user/default/resources/default/phase_4/models/minigames/toonblitz_game_elevator')
        self.arrow = loader.loadModel(
            '../../user/default/resources/default/phase_4/models/minigames/toonblitz_game_arrow')
        self.sprayProp = loader.loadModel(
            '../../user/default/resources/default/phase_4/models/minigames/prop_waterspray')
        self.treasureModelList = []
        salesIcon = loader.loadModel('../../user/default/resources/default/phase_4/models/minigames/salesIcon')
        self.treasureModelList.append(salesIcon)
        moneyIcon = loader.loadModel('../../user/default/resources/default/phase_4/models/minigames/moneyIcon')
        self.treasureModelList.append(moneyIcon)
        legalIcon = loader.loadModel('../../user/default/resources/default/phase_4/models/minigames/legalIcon')
        self.treasureModelList.append(legalIcon)
        corpIcon = loader.loadModel('../../user/default/resources/default/phase_4/models/minigames/corpIcon')
        self.treasureModelList.append(corpIcon)
        self.particleGlow = loader.loadModel(
            '../../user/default/resources/default/phase_4/models/minigames/particleGlow')
        self.blockTypes = []
        for i in range(4):
            blockType = loader.loadModel(
                '../../user/default/resources/default/phase_4/models/minigames/toonblitz_game_block0' + str(i))
            self.blockTypes.append(blockType)

        self.stomper = loader.loadModel(
            '../../user/default/resources/default/phase_4/models/minigames/toonblitz_game_stomper')
        ...
        self.gameMusic = base.loader.loadMusic(
            '../../user/default/resources/default/phase_4/audio/bgm/MG_TwoDGame.ogg')
        self.treasureGrabSound = loader.loadSfx(
            '../../user/default/resources/default/phase_4/audio/sfx/SZ_DD_treasure.ogg')
        ...
        self.watergunSound = base.loader.loadSfx(
            '../../user/default/resources/default/phase_4/audio/sfx/AA_squirt_seltzer_miss.ogg')
        self.splashSound = base.loader.loadSfx(
            '../../user/default/resources/default/phase_4/audio/sfx/Seltzer_squirt_2dgame_hit.ogg')
        self.threeSparkles = loader.loadSfx(
            '../../user/default/resources/default/phase_4/audio/sfx/threeSparkles.ogg')
        self.sparkleSound = loader.loadSfx('../../user/default/resources/default/phase_4/audio/sfx/sparkly.ogg')
