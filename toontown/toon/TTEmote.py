...
def doVictory(toon, volume=1):
    ...
    sfx = base.loader.loadSfx('../../user/default/resources/default/phase_3.5/audio/sfx/ENC_Win.ogg')
...
def doAnnoyed(toon, volume=1):
    ...
    if toon.style.getAnimal() == 'bear':
        sfx = base.loader.loadSfx('../../user/default/resources/default/phase_3.5/audio/dial/AV_bear_exclaim.ogg')
    else:
        sfx = base.loader.loadSfx(
            '../../user/default/resources/default/phase_3.5/audio/sfx/avatar_emotion_angry.ogg')
...
def doSleep(toon, volume=1):
    ...
    track = Sequence(
        Func(
            toon.stopLookAround), Func(
            toon.stopBlink), Func(
                toon.closeEyes), Func(
                    toon.lerpLookAt, Point3(
                        0, 1, -4)), Func(
                            toon.loop, 'neutral'), Func(
                                toon.setPlayRate, 0.4, 'neutral'), Func(
                                    toon.setChatAbsolute, TTLocalizer.ToonSleepString, CFThought))
    ...
    for lod in toon.getLODNames():
        ...
        tracks.append(
            Sequence(
                LerpHprInterval(
                    h, 0.1, Vec3(
                        0, -30, 0)), LerpHprInterval(
                    h, 0.15, Vec3(
                        0, 20, 0)), LerpHprInterval(
                            h, 0.15, Vec3(
                                0, -20, 0)), LerpHprInterval(
                                    h, 0.15, Vec3(
                                        0, 20, 0)), LerpHprInterval(
...
def doNo(toon, volume=1):
    ...
    for lod in toon.getLODNames():
        h = toon.getPart('head', lod)
        tracks.append(Sequence(LerpHprInterval(h,
                                               0.1,
                                               Vec3(40,
                                                    0,
                                                    0)),
...
def doShrug(toon, volume=1):
    sfx = base.loader.loadSfx('../../user/default/resources/default/phase_3.5/audio/sfx/avatar_emotion_shrug.ogg')
...
def doApplause(toon, volume=1):
    sfx = base.loader.loadSfx('../../user/default/resources/default/phase_4/audio/sfx/avatar_emotion_applause.ogg')
...
def doConfused(toon, volume=1):
    sfx = base.loader.loadSfx('../../user/default/resources/default/phase_4/audio/sfx/avatar_emotion_confused.ogg')
...
def doSlipForward(toon, volume=1):
    sfx = base.loader.loadSfx('../../user/default/resources/default/phase_4/audio/sfx/MG_cannon_hit_dirt.ogg')
...
def doBored(toon, volume=1):
    sfx = base.loader.loadSfx('../../user/default/resources/default/phase_4/audio/sfx/avatar_emotion_bored.ogg')
...
def doSurprise(toon, volume=1):
    sfx = None
    sfx = base.loader.loadSfx('../../user/default/resources/default/phase_4/audio/sfx/avatar_emotion_surprise.ogg')
    ...
    track = Sequence(
        Func(
            toon.stopBlink), Func(
            toon.surpriseEyes), Func(
                toon.showSurpriseMuzzle), Parallel(
                    Func(
                        playAnim, anim), Func(
                            playSfx, volume)))
    exitTrack = Sequence(
        Func(
            toon.hideSurpriseMuzzle), Func(
            toon.openEyes), Func(
                toon.startBlink), Func(
                    stopAnim, anim))
...
def doUpset(toon, volume=1):
    sfx = None
    sfx = base.loader.loadSfx(
        '../../user/default/resources/default/phase_4/audio/sfx/avatar_emotion_very_sad_1.ogg')
    ...
    track = Sequence(
        Func(
            toon.sadEyes), Func(
            toon.blinkEyes), Func(
                toon.showSadMuzzle), Parallel(
                    Func(
                        playAnim, anim), Func(
                            playSfx, volume)))
    exitTrack = Sequence(
        Func(
            toon.hideSadMuzzle), Func(
            toon.normalEyes), Func(
                stopAnim, anim))
...
def doDelighted(toon, volume=1):
    sfx = None
    sfx = base.loader.loadSfx('../../user/default/resources/default/phase_4/audio/sfx/delighted_06.ogg')
    ...
    anim = Sequence(
        ActorInterval(
            toon, 'left'), Wait(1), ActorInterval(
            toon, 'left', playRate=-1))
    track = Sequence(
        Func(
            toon.blinkEyes), Func(
            toon.showSmileMuzzle), Parallel(
                Func(
                    playAnim, anim), Func(
                        playSfx, volume)))
    exitTrack = Sequence(
        Func(
            toon.hideSmileMuzzle), Func(
            toon.blinkEyes), Func(
                stopAnim, anim))
...
def doFurious(toon, volume=1):
    duration = toon.getDuration('angry', 'torso')
    sfx = None
    sfx = base.loader.loadSfx('../../user/default/resources/default/phase_4/audio/sfx/furious_03.ogg')
    ...
    track = Sequence(
        Func(
            toon.angryEyes), Func(
            toon.blinkEyes), Func(
                toon.showAngryMuzzle), Func(
                    toon.play, 'angry'), Func(
                        playSfx, volume))
    exitTrack = Sequence(
        Func(
            toon.normalEyes), Func(
...
def doLaugh(toon, volume=1):
    sfx = None
    sfx = base.loader.loadSfx('../../user/default/resources/default/phase_4/audio/sfx/avatar_emotion_laugh.ogg')
    ...
    track = Sequence(
        Func(
            toon.blinkEyes), Func(
            toon.showLaughMuzzle), Func(playAnim), Func(
                playSfx, volume))
    exitTrack = Sequence(
        Func(
            toon.hideLaughMuzzle), Func(
            toon.blinkEyes), Func(stopAnim))
    return (track, 2, exitTrack)


def getSingingNote(toon, note, volume=1):
    sfx = None
    filePath = '../../user/default/resources/default/phase_3.5/audio/dial/'
