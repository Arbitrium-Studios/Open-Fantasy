...
class LocalToon(DistributedToon.DistributedToon, LocalAvatar.LocalAvatar):
    ...
    def __init__(self, cr):
        try:
            ...
            self.soundRun = base.loader.loadSfx(
                '../../user/default/resources/default/phase_3.5/audio/sfx/AV_footstep_runloop.ogg')
            self.soundWalk = base.loader.loadSfx(
                '../../user/default/resources/default/phase_3.5/audio/sfx/AV_footstep_walkloop.ogg')
            self.soundWhisper = base.loader.loadSfx(
                '../../user/default/resources/default/phase_3.5/audio/sfx/GUI_whisper_3.ogg')
            self.soundPhoneRing = base.loader.loadSfx(
                '../../user/default/resources/default/phase_3.5/audio/sfx/telephone_ring.ogg')
    ...
    def loadClarabelleGui(self):
        if self.__clarabelleButton:
            return
        guiItems = loader.loadModel('../../user/default/resources/default/phase_5.5/models/gui/catalog_gui')
    ...
    def __placeMarker(self):
        pos = self.getPos()
        hpr = self.getHpr()
        chest = loader.loadModel('../../user/default/resources/default/phase_4/models/props/coffin')
    ...
    def loadGardeningGui(self):
        if self.__gardeningGui:
            return
        gardenGuiCard = loader.loadModel('../../user/default/resources/default/phase_5.5/models/gui/planting_gui')
        ...
        shovelCardP = loader.loadModel(
            '../../user/default/resources/default/phase_5.5/models/gui/planting_but_shovel_P')
        shovelCardY = loader.loadModel(
            '../../user/default/resources/default/phase_5.5/models/gui/planting_but_shovel_Y')
        wateringCanCardP = loader.loadModel(
            '../../user/default/resources/default/phase_5.5/models/gui/planting_but_can_P')
        wateringCanCardY = loader.loadModel(
            '../../user/default/resources/default/phase_5.5/models/gui/planting_but_can_Y')
        backCard = loader.loadModel('../../user/default/resources/default/phase_5.5/models/gui/planting_gui')
        iconImage = None
        iconModels = loader.loadModel('../../user/default/resources/default/phase_3.5/models/gui/sos_textures')
    ...
    def promoteShovelSkill(self, shovelLevel, shovelSkill):
        ...
        messageScale = 0.07
        image = loader.loadModel('../../user/default/resources/default/phase_5.5/models/gui/planting_but_shovel_P')
    ...
    def promoteWateringCan(self, wateringCanlevel=0):
        ...
        messagePos = Vec2(0, 0.2)
        messageScale = 0.08
        image = loader.loadModel('../../user/default/resources/default/phase_5.5/models/gui/planting_but_can_P')
