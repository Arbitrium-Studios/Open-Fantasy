...
class DistributedToon(DistributedPlayer.DistributedPlayer, Toon.Toon,
    ...
    def setDefaultZone(self, zoneId):
        ...
        try:
            ...
            self.defaultZone = ToontownPlaza
            return
    ...
    def reconsiderCheesyEffect(self, lerpTime=0):
        ...
        if hoodId != 0:
            ...
            if hoodId == 1:
                if currentHoodId == ToontownGlobals.ToontownPlaza:
                    effect = CENormal
    ...
    def playSplashEffect(self, x, y, z):
        if localAvatar.zoneId not in [ToontownGlobals.ToontownsShipyard, ToontownGlobals.AcornAcres] and (
