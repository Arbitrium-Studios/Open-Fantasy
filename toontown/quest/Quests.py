...
QuestDict = {
    ...
    121: (TT_TIER,
          OBSOLETE,
          (RecoverItemQuest,
           ToontownGlobals.ToontropolisCenter,
           1,
           2,
           VeryEasy,
           Any,
...
class CheesyEffectReward(Reward):
    ...
    def getString(self):
        ...
        if hoodId == 0:
            ...
            whileStr = TTLocalizer.CheesyEffectExceptIn % TTLocalizer.ToontropolisCenter[-1]
        else:
            hoodName = base.cr.hoodMgr.getFullnameFromId(hoodId)
...
RewardDict = {100: (MaxHpReward, 1),
              ...
              300: (TeleportReward, ToontownGlobals.ToontropolisCenter),
