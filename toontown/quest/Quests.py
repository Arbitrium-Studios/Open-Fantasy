...
class Quest:
    ...
    def checkCogType(self, type):
        types = [Any] + list(SuitBattleGlobals.SuitAttributesDict.keys())
    ...
    def checkRecoveryItemHolderAndType(self, holder, holderType='type'):
        ...
        if holderType == 'type':
            holders = [Any, AnyFish] + \
                list(SuitBattleGlobals.SuitAttributesDict.keys())
            self.check(
...
RewardDict = {100: (MaxHpReward, 1),
              ...
              301: (TeleportReward, ToontownGlobals.FoggyFjord),
              302: (TeleportReward, ToontownGlobals.FloweringGrove),
              303: (TeleportReward, ToontownGlobals.HarmoniousHaven),
