...
class CheesyEffectReward(Reward):
    ...
    def getString(self):
        ...
        if hoodId == 0:
            ...
            whileStr = TTLocalizer.CheesyEffectExceptIn % TTLocalizer.ToontownPlaza[-1]
        else:
            hoodName = base.cr.hoodMgr.getFullnameFromId(hoodId)
...
RewardDict = {100: (MaxHpReward, 1),
              ...
              300: (TeleportReward, ToontownGlobals.ToontownPlaza),
              301: (TeleportReward, ToontownGlobals.ToontownsShipyard),
