...
class BlinkingArrows:
    ...
    def __init__(self, parent=aspect2d, otherNode=None):
        self.arrow1 = loader.loadModel('../../user/default/resources/default/phase_3/models/props/arrow')
        self.arrow2 = loader.loadModel('../../user/default/resources/default/phase_3/models/props/arrow')
