...
class QuestMap(DirectFrame):
    ...
    def load(self):
        gui = loader.loadModel('../../user/default/resources/default/phase_4/models/questmap/questmap_gui')
        ...
        if self.av:
            try:
                ...
                mapsGeom = loader.loadModel(
                    '../../user/default/resources/default/phase_4/models/questmap/%s_maps' %
    ...
    def initMarker(self, task):
        if self.av:
            if not hasattr(base.cr.playGame.getPlace(
