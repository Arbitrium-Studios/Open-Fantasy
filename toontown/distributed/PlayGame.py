...
class PlayGame(StateData.StateData):
    ...
    def loadDnaStoreTutorial(self):
        ...
        loader.loadDNAFile(self.dnaStore, '../../user/default/resources/default/phase_3.5/dna/storage_tutorial.dna')
        loader.loadDNAFile(self.dnaStore, '../../user/default/resources/default/phase_3.5/dna/storage_interior.dna')
    ...
    def loadDnaStore(self):
        if not hasattr(self, 'dnaStore'):
            ...
            loader.loadDNAFile(
                self.dnaStore,
                '../../user/default/resources/default/phase_3.5/dna/storage_interior.dna')
