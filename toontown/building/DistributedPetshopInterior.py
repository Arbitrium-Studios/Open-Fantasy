...
class DistributedPetshopInterior(DistributedObject.DistributedObject):
    ...
    def setup(self):
        ...
        self.interior = loader.loadModel(
            '../../user/default/resources/default/phase_4/models/modules/PetShopInterior')
        self.interior.reparentTo(render)
        self.fish = Actor.Actor('../../user/default/resources/default/phase_4/models/props/interiorfish-zero',
                                {'swim': '../../user/default/resources/default/phase_4/models/props/interiorfish-swim'})
