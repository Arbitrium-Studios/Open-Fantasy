...
def getOpenInterval(distObj, leftDoor, rightDoor, openSfx,
                    finalOpenSfx, type=ELEVATOR_NORMAL):
...
def getCloseInterval(distObj, leftDoor, rightDoor, closeSfx,
                     finalCloseSfx, type=ELEVATOR_NORMAL):
