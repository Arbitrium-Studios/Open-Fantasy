...
baseScheme = {'TI_wainscotting': wainscottingBase,
              ...
              'TI_door': doorBase,
              'TI_floor': floorBase}
colors = {ToontropolisDocks: {'TI_wainscotting': wainscottingBase,
                        'TI_wallpaper': wallpaperBase,
                        'TI_wallpaper_border': wallpaperBorderBase,
                        'TI_door': doorBase,
                        'TI_floor': floorBase},
          ToontropolisPlaza: {'TI_wainscotting': wainscottingBase,
                            'TI_wallpaper': wallpaperBase,
                            'TI_wallpaper_border': wallpaperBorderBase,
          ...
          DowntownToontropolis: baseScheme,
          TwilightSlumberland: {'TI_wainscotting': wainscottingBase,
                             'TI_wallpaper': wallpaperBase,
                             'TI_wallpaper_border': wallpaperBorderBase,
                             'TI_door': doorBase,
                             'TI_floor': floorBase},
