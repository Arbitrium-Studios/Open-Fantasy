...
class DistributedHQInterior(DistributedObject.DistributedObject):
    ...
    def generate(self):
        ...
        self.interior = loader.loadModel(
            '../../user/default/resources/default/phase_3.5/models/modules/HQ_interior')
    ...
    def buildTrophyStar(self):
        trophyStar = loader.loadModel('../../user/default/resources/default/phase_3.5/models/gui/name_star')
        trophyStar.hide()
