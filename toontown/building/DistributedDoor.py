...
class DistributedDoor(DistributedObject.DistributedObject, DelayDeletable):
    ...
    def __init__(self, cr):
        ...
        self.openSfx = base.loader.loadSfx(
            '../../user/default/resources/default/phase_3.5/audio/sfx/Door_Open_1.ogg')
        self.closeSfx = base.loader.loadSfx(
            '../../user/default/resources/default/phase_3.5/audio/sfx/Door_Close_1.ogg')
        self.nametag = None
    ...
    def avatarExitTrack(self, avatar, duration):
        ...
        if avatar.doId == base.localAvatar.doId:
            track.append(PosHprInterval(camera, VBase3(-self.doorX, 5,
                         avatar.getHeight()), VBase3(180, 0, 0), other=otherNP))
        if avatar.doId == base.localAvatar.doId:
