...
__fishDict = {0: ((1,
                  ...
                  (1,
                   5,
                   2,
                   (TTG.LoopyLane, TTG.ToontownCenter))),
              2: ((2,
                   6,
                   1,
              ...
              4: ((2,
                  ...
                  8,
                  6,
                  (TTG.ToontownCenter, TTG.TheLandOfMusic))),
              6: ((8,
                   12,
                   1,
              ...
              12: ((7,
                    15,
                    1,
                    (TTG.ToontownShipyards, Anywhere)),
                   (18,
                    20,
                    6,
                    (TTG.ToontownShipyards, TTG.MyEstate)),
                   (1,
                    5,
                    5,
                    (TTG.ToontownShipyards, TTG.MyEstate)),
              ...
              18: ((2,
                    4,
                    3,
                    (TTG.ToontownShipyards, Anywhere)), (5,
                                                   8,
                                                   7,
              ...
              24: ((9,
                   ...
                   (8,
                    12,
                    5,
                    (TTG.FloweringGrove, TTG.ToontownShipyards)),
                   (8,
                    12,
                    6,
                    (TTG.FloweringGrove, TTG.ToontownShipyards)),
              ...
              28: ((2,
                    10,
                    2,
                    (TTG.ToontownShipyards, Anywhere)), (4,
                                                   10,
                                                   6,
                                                   (TTG.BarnacleBoulevard, TTG.ToontownShipyards)), (4,
                                                                                               10,
                                                                                               7,
                                                                                               (TTG.SeaweedStreet, TTG.ToontownShipyards))),
              30: ((13,
                    17,
                    5,
                    (TTG.TheLandOfMusic, Anywhere)),
              ...
              32: ((1,
                    5,
                    2,
                    (TTG.ToontownCenter, TTG.MyEstate, Anywhere)),
                   (1,
                    5,
                    3,
