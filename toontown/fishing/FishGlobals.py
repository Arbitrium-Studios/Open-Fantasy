...
__fishDict = {0: ((1,
                  ...
                  (1,
                   1,
                   4,
                   (TTG.ToontropolisPlaza, Anywhere)),
                  (3,
                   5,
                   5,
                  ...
                  (1,
                   5,
                   2,
                   (TTG.LoopyLane, TTG.ToontropolisPlaza))),
              2: ((2,
                   6,
                   1,
                   (TTG.FloweringGrove, Anywhere)),
                  (2,
                  6,
                  9,
                  ...
                  6,
                  3,
                  (TTG.FloweringGrove, TTG.MyEstate)),
                  (5,
                  11,
                  2,
                  (TTG.TwilightSlumberland, TTG.MyEstate))),
              4: ((2,
                   8,
                   1,
                   (TTG.ToontropolisPlaza, Anywhere)),
                  ...
                  8,
                  6,
                  (TTG.ToontropolisPlaza, TTG.TheLandOfMusic))),
              6: ((8,
                   12,
                   1,
              ...
              12: ((7,
                    15,
                    1,
                    (TTG.ToontropolisDocks, Anywhere)),
                   (18,
                    20,
                    6,
                    (TTG.ToontropolisDocks, TTG.MyEstate)),
                   (1,
                    5,
                    5,
                    (TTG.ToontropolisDocks, TTG.MyEstate)),
              ...
              14: ((2,
                    6,
                    1,
                    (TTG.FloweringGrove, TTG.MyEstate, Anywhere)), (2,
                                                                  6,
                                                                  3,
                                                                  (TTG.FloweringGrove, TTG.MyEstate))),
              16: ((4,
                    12,
                    5,
                    (TTG.TheLandOfMusic, Anywhere)), (4,
                                                         12,
                                                         7,
                                                         (TTG.BaritoneBoulevard, TTG.TheLandOfMusic)), (4,
                                                                                                           12,
                                                                                                           8,
                                                                                                           (TTG.TenorTerrace, TTG.TheLandOfMusic))),
              18: ((2,
                    4,
                    3,
                    (TTG.ToontropolisDocks, Anywhere)), (5,
                                                   8,
                                                   7,
              ...
              20: ((4,
                   ...
                   (10,
                    14,
                    4,
                    (TTG.TwilightSlumberland, TTG.FloweringGrove))),
              22: ((12,
                    16,
                    2,
                    (TTG.MyEstate, TTG.FloweringGrove, Anywhere)),
                   (14,
                    18,
                    3,
                    (TTG.MyEstate, TTG.FloweringGrove, Anywhere)),
                   (14,
                    20,
                    5,
                    (TTG.MyEstate, TTG.FloweringGrove)),
                   (14,
                    20,
                    7,
                    (TTG.MyEstate, TTG.FloweringGrove))),
              24: ((9,
                   ...
                   (8,
                    12,
                    5,
                    (TTG.FloweringGrove, TTG.ToontropolisDocks)),
                   (8,
                    12,
                    6,
                    (TTG.FloweringGrove, TTG.ToontropolisDocks)),
              ...
              28: ((2,
                    10,
                    2,
                    (TTG.ToontropolisDocks, Anywhere)), (4,
                                                   10,
                                                   6,
                                                   (TTG.BarnacleBoulevard, TTG.ToontropolisDocks)), (4,
                                                                                               10,
                                                                                               7,
                                                                                               (TTG.SeaweedStreet, TTG.ToontropolisDocks))),
              30: ((13,
                    17,
                    5,
                    (TTG.TheLandOfMusic, Anywhere)),
                   (16,
                    20,
                    10,
                    (TTG.AltoAvenue, TTG.TheLandOfMusic)),
                   (12,
                    18,
                    9,
                    (TTG.TenorTerrace, TTG.TheLandOfMusic)),
              ...
              32: ((1,
                    5,
                    2,
                    (TTG.ToontropolisPlaza, TTG.MyEstate, Anywhere)),
                   (1,
                    5,
                    3,
                    (TTG.TundraWonderland, TTG.MyEstate, Anywhere)),
                   (1,
                    5,
                    4,
                    (TTG.FloweringGrove, TTG.MyEstate)),
                   ...
                   (1,
                    5,
                    10,
                    (TTG.TundraWonderland, TTG.TwilightSlumberland))),
              34: ((1,
                    20,
                    10,
                    (TTG.TwilightSlumberland, Anywhere)),)}
