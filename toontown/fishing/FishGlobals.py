...
__fishDict = {0: ((1,
                  ...
                  (1,
                   5,
                   2,
                   (TTG.LoopyLane, TTG.ToontownPlaza))),
              2: ((2,
                   6,
                   1,
              ...
              4: ((2,
                  ...
                  8,
                  6,
                  (TTG.ToontownPlaza, TTG.TheLandOfMusic))),
              6: ((8,
                   12,
                   1,
              ...
              12: ((7,
                    15,
                    1,
                    (TTG.ToontownsShipyard, Anywhere)),
                   (18,
                    20,
                    6,
                    (TTG.ToontownsShipyard, TTG.MyEstate)),
                   (1,
                    5,
                    5,
                    (TTG.ToontownsShipyard, TTG.MyEstate)),
              ...
              18: ((2,
                    4,
                    3,
                    (TTG.ToontownsShipyard, Anywhere)), (5,
                                                   8,
                                                   7,
              ...
              24: ((9,
                   ...
                   (8,
                    12,
                    5,
                    (TTG.FloweringGrove, TTG.ToontownsShipyard)),
                   (8,
                    12,
                    6,
                    (TTG.FloweringGrove, TTG.ToontownsShipyard)),
              ...
              28: ((2,
                    10,
                    2,
                    (TTG.ToontownsShipyard, Anywhere)), (4,
                                                   10,
                                                   6,
                                                   (TTG.BarnacleBoulevard, TTG.ToontownsShipyard)), (4,
                                                                                               10,
                                                                                               7,
                                                                                               (TTG.SeaweedStreet, TTG.ToontownsShipyard))),
              30: ((13,
                    17,
                    5,
                    (TTG.TheLandOfMusic, Anywhere)),
              ...
              32: ((1,
                    5,
                    2,
                    (TTG.ToontownPlaza, TTG.MyEstate, Anywhere)),
                   (1,
                    5,
                    3,
