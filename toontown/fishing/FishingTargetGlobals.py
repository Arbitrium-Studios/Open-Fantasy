...
__targetInfoDict = {
    ...
    # TT
    ToontownGlobals.ToontropolisPlaza : (2, -81, 31, -4.8, 14, -1.4),
    ...
    # DD
    ToontownGlobals.ToontropolisDocks : (2, -17, 130, 1.730, 15, (1.730 - 3.615)),
    ...
    ToontownGlobals.FloweringGrove : (2, 50, 47, -1.48, 13, (-1.48 - 0.345)),
    ...
    # MM
    ToontownGlobals.TheLandOfMusic : (2, -0.2, -20.2, -14.65, 14, (-14.65 - (-12))),
    ...
    # BR
    ToontownGlobals.TundraWonderland : (2, -58, -26, 1.7, 10, -0.8),
    ...
    # DL
    ToontownGlobals.TwilightDreamland : (2, 159, 0.2, -17.1, 14, (-17.1 - (- 14.6))),
