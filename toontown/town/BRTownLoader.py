...
class BRTownLoader(TownLoader.TownLoader):
    ...
    def __init__(self, hood, parentFSM, doneEvent):
        ...
        self.musicFile = 'user/resources/default/phase_8/audio/bgm/TB_SZ.ogg'
        self.activityMusicFile = 'user/resources/default/phase_8/audio/bgm/TB_SZ_activity.ogg'
        self.townStorageDNAFile = 'user/resources/default/phase_8/dna/storage_BR_town.dna'

    def load(self, zoneId):
        TownLoader.TownLoader.load(self, zoneId)
        Suit.loadSuits(3)
        dnaFile = 'user/resources/default/phase_8/dna/the_burrrgh_' + \
