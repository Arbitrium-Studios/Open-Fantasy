...
class ClosetGUI(ClothesGUI.ClothesGUI):
    ...
    def __init__(self, isOwner, doneEvent, cancelEvent, swapEvent,
                 deleteEvent, topList=None, botList=None):
    ...
    def load(self):
        ...
        if self.isOwner:
            trashcanGui = loader.loadModel(
                '../../user/default/resources/default/phase_3/models/gui/trashcan_gui.bam')
            trashImage = (
