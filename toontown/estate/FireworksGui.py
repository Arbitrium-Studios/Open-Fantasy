...
class FireworksGui(DirectFrame):
    ...
    def load(self):
        ...
        self.cancelButton = DirectButton(parent=self, relief=None, image=cancelImageList, pos=(
            0.15, 0, -0.62), text_scale=0.06, text_pos=(0, -0.1), command=self.__cancel)
        buttons.removeNode()
