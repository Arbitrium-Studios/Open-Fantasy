...
class DistributedToonStatuary(DistributedStatuary.DistributedStatuary):
    ...
    def removeTextures(self):
        ...
        desatShirtTex = loader.loadTexture('../../user/default/resources/default/phase_3/maps/desat_shirt_1.jpg')
        desatSleeveTex = loader.loadTexture('../../user/default/resources/default/phase_3/maps/desat_sleeve_1.jpg')
        desatShortsTex = loader.loadTexture('../../user/default/resources/default/phase_3/maps/desat_shorts_1.jpg')
        desatSkirtTex = loader.loadTexture('../../user/default/resources/default/phase_3/maps/desat_skirt_1.jpg')
        if self.toon.hasLOD():
    ...
    def setStoneTexture(self):
        ...
        stoneTex = loader.loadTexture('../../user/default/resources/default/phase_5.5/maps/smoothwall_1.jpg')
        ts = TextureStage('ts')
        ts.setPriority(1)
