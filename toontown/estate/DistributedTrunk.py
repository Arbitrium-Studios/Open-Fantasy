...
class DistributedTrunk(DistributedCloset.DistributedCloset):
    ...
    def d_setDNA(self, hatIdx, hatTexture, hatColor, glassesIdx, glassesTexture, glassesColor, backpackIdx, backpackTexture, backpackColor,
                 shoesIdx, shoesTexture, shoesColor, finished, which=ToonDNA.HAT | ToonDNA.GLASSES | ToonDNA.BACKPACK | ToonDNA.SHOES):
    ...
    def setCustomerDNA(self, avId, hatIdx, hatTexture, hatColor, glassesIdx, glassesTexture, glassesColor,
                       backpackIdx, backpackTexture, backpackColor, shoesIdx, shoesTexture, shoesColor, which):
