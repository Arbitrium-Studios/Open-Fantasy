...
class DistributedTarget(DistributedObject.DistributedObject):
    ...
    def load(self):
        ...
        self.timer.hide()
        self.geom = loader.loadModel('user/resources/default/phase_5.5/models/estate/target')
        self.geom.reparentTo(base.cr.playGame.hood.loader.geom)
        self.geom.setPos(0, 0, 40)
        self.geom.setScale(3)
        self.geom.stash()
        self.hitSound = base.loader.loadSfx('user/resources/default/phase_4/audio/sfx/MG_Tag_A.ogg')
