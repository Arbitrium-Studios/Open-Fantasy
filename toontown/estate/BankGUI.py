...
class BankGui(DirectFrame):
    ...
    def __init__(self, doneEvent, allowWithdraw=1):
        ...
        arrowGui = loader.loadModel('../../user/default/resources/default/phase_3/models/gui/create_a_toon_gui')
        bankModel = loader.loadModel(
            '../../user/default/resources/default/phase_5.5/models/estate/jellybeanBank.bam')
        ...
        self.cancelButton = DirectButton(
            parent=self, relief=None, image=cancelImageList, pos=(
                -0.2, 0, -0.4), text=TTLocalizer.BankGuiCancel, text_scale=0.06, text_pos=(
                0, -0.1), command=self.__cancel)
        self.okButton = DirectButton(
            parent=self, relief=None, image=okImageList, pos=(
                0.2, 0, -0.4), text=TTLocalizer.BankGuiOk, text_scale=0.06, text_pos=(
                0, -0.1), command=self.__requestTransaction)
        self.jarDisplay = DirectLabel(
            parent=self, relief=None, pos=(
                -0.4, 0, 0), scale=0.7, text=str(
                base.localAvatar.getMoney()), text_scale=0.2, text_fg=(
                0.95, 0.95, 0, 1), text_shadow=(
                    0, 0, 0, 1), text_pos=(
                        0, -0.1, 0), image=jarGui.find('**/Jar'), text_font=ToontownGlobals.getSignFont())
        self.bankDisplay = DirectLabel(
            parent=self, relief=None, pos=(
                0.4, 0, 0), scale=0.9, text=str(
                base.localAvatar.getBankMoney()), text_scale=0.2, text_fg=(
                0.95, 0.95, 0, 1), text_shadow=(
                    0, 0, 0, 1), text_pos=(
                        0, -0.1, 0), geom=bankModel, geom_scale=0.08, geom_pos=(
                            0, 10, -0.26), geom_hpr=(
        ...
        self.depositArrow = DirectButton(
            parent=self, relief=None, image=arrowImageList, image_scale=(
                ...
                0.6, 0.6, 0.6, 0.25), pos=(
                0.01, 0, 0.15))
        self.withdrawArrow = DirectButton(parent=self, relief=None, image=arrowImageList, image_scale=(
            -1, 1, 1), image3_color=Vec4(0.6, 0.6, 0.6, 0.25), pos=(-0.01, 0, -0.15))
