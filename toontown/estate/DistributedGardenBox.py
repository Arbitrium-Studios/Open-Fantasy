...
class DistributedGardenBox(DistributedLawnDecor.DistributedLawnDecor):
    ...
    def __init__(self, cr):
        ...
        self.defaultModel = '../../user/default/resources/default/phase_5.5/models/estate/planterC'
    ...
    def doModelSetup(self):
        if self.typeIndex == GardenGlobals.BOX_THREE:
            self.defaultModel = '../../user/default/resources/default/phase_5.5/models/estate/planterA'
        elif self.typeIndex == GardenGlobals.BOX_TWO:
            self.defaultModel = '../../user/default/resources/default/phase_5.5/models/estate/planterC'
        else:
            self.defaultModel = '../../user/default/resources/default/phase_5.5/models/estate/planterD'
