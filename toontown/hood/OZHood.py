...
class OZHood(ToonHood.ToonHood):
    ...
    def __init__(self, parentFSM, doneEvent, dnaStore, hoodId):
        ...
        self.storageDNAFile = '../../user/default/resources/default/phase_6/dna/storage_OZ.dna'
        self.holidayStorageDNADict = {HALLOWEEN_PROPS: ['../../user/default/resources/default/phase_6/dna/halloween_props_storage_OZ.dna'],
                                      SPOOKY_PROPS: ['../../user/default/resources/default/phase_6/dna/halloween_props_storage_OZ.dna']}
