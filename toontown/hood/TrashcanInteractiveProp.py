...
class TrashcanInteractiveProp(InteractiveAnimatedProp.InteractiveAnimatedProp):
    ...
    ZoneToIdles = {ToontownGlobals.ToontownCentral: (('tt_a_ara_ttc_trashcan_idleTake2',
                                                     ...
                                                     ('tt_a_ara_ttc_trashcan_idleAwesome3',
                                                      ...
                                                      3,
                                                      10)),
                   ToontownGlobals.FoggyFjords: (('tt_a_ara_dod_trashcan_idleBounce2',
                                                  3,
                                                  10,
                   ...
                   ToontownGlobals.FloweringGrove: (('tt_a_ara_dga_trashcan_idleTake2',
                                                  ...
                                                  ('tt_a_ara_dga_trashcan_idleAwesome3',
                                                   ...
                                                   3,
                                                   10)),
                   ToontownGlobals.HarmoniousHaven: (('tt_a_ara_mml_trashcan_idleBounce0',
                                                        3,
                                                        10,
    ...
    ZoneToIdleIntoFightAnims = {ToontownGlobals.ToontownCentral: 'tt_a_ara_ttc_trashcan_idleIntoFight',
                                ToontownGlobals.FoggyFjords: 'tt_a_ara_dod_trashcan_idleIntoFight',
                                ToontownGlobals.FloweringGrove: 'tt_a_ara_dga_trashcan_idleIntoFight',
                                ToontownGlobals.HarmoniousHaven: 'tt_a_ara_mml_trashcan_idleIntoFight',
    ...
    ZoneToVictoryAnims = {ToontownGlobals.ToontownCentral: 'tt_a_ara_ttc_trashcan_victoryDance',
                          ToontownGlobals.FoggyFjords: 'tt_a_ara_dod_trashcan_victoryDance',
                          ToontownGlobals.FloweringGrove: 'tt_a_ara_dga_trashcan_victoryDance',
                          ToontownGlobals.HarmoniousHaven: 'tt_a_ara_mml_trashcan_victoryDance',
    ...
    ZoneToSadAnims = {ToontownGlobals.ToontownCentral: 'tt_a_ara_ttc_trashcan_fightSad',
                      ToontownGlobals.FoggyFjords: 'tt_a_ara_dod_trashcan_fightSad',
                      ToontownGlobals.FloweringGrove: 'tt_a_ara_dga_trashcan_fightSad',
                      ToontownGlobals.HarmoniousHaven: 'tt_a_ara_mml_trashcan_fightSad',
    ...
    ZoneToFightAnims = {ToontownGlobals.ToontownCentral: ('tt_a_ara_ttc_trashcan_fightBoost', 'tt_a_ara_ttc_trashcan_fightCheer', 'tt_a_ara_ttc_trashcan_fightIdle'),
                        ToontownGlobals.FoggyFjords: ('tt_a_ara_dod_trashcan_fightBoost', 'tt_a_ara_dod_trashcan_fightCheer', 'tt_a_ara_dod_trashcan_fightIdle'),
                        ...
                        ToontownGlobals.HarmoniousHaven: ('tt_a_ara_mml_trashcan_fightBoost',
