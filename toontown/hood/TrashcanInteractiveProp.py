...
class TrashcanInteractiveProp(InteractiveAnimatedProp.InteractiveAnimatedProp):
    ...
    ZoneToIdles = {ToontownGlobals.ToontownPlaza: (('tt_a_ara_ttc_trashcan_idleTake2',
                                                      1,
                                                      1,
                                                      None,
                                                      3,
                                                     ...
                                                     ('tt_a_ara_ttc_trashcan_idleAwesome3',
                                                      ...
                                                      3,
                                                      10)),
                   ToontownGlobals.ToontownsShipyard: (('tt_a_ara_dod_trashcan_idleBounce2',
                                                  3,
                                                  10,
                   ...
                   ToontownGlobals.TwilightDreamland: (('tt_a_ara_ddl_trashcan_idleSleep0',
                                                      ...
                                                      ('tt_a_ara_ddl_trashcan_idleAwesome3',
                                                       ...
                                                       0,
                                                       0))}
    ZoneToIdleIntoFightAnims = {ToontownGlobals.ToontownPlaza: 'tt_a_ara_ttc_trashcan_idleIntoFight',
                                ToontownGlobals.ToontownsShipyard: 'tt_a_ara_dod_trashcan_idleIntoFight',
    ...
    ZoneToVictoryAnims = {ToontownGlobals.ToontownPlaza: 'tt_a_ara_ttc_trashcan_victoryDance',
                          ToontownGlobals.ToontownsShipyard: 'tt_a_ara_dod_trashcan_victoryDance',
    ...
    ZoneToSadAnims = {ToontownGlobals.ToontownPlaza: 'tt_a_ara_ttc_trashcan_fightSad',
                      ToontownGlobals.ToontownsShipyard: 'tt_a_ara_dod_trashcan_fightSad',
    ...
    ZoneToFightAnims = {ToontownGlobals.ToontownPlaza: ('tt_a_ara_ttc_trashcan_fightBoost', 'tt_a_ara_ttc_trashcan_fightCheer', 'tt_a_ara_ttc_trashcan_fightIdle'),
                        ToontownGlobals.ToontownsShipyard: ('tt_a_ara_dod_trashcan_fightBoost', 'tt_a_ara_dod_trashcan_fightCheer', 'tt_a_ara_dod_trashcan_fightIdle'),
