...
class TrashcanInteractiveProp(InteractiveAnimatedProp.InteractiveAnimatedProp):
    ...
    ZoneToIdles = {ToontownGlobals.ToontropolisPlaza: (('tt_a_ara_ttc_trashcan_idleTake2',
                                                      1,
                                                      1,
                                                      None,
                                                      3,
                   ...
                   ToontownGlobals.TwilightSlumberland: (('tt_a_ara_ddl_trashcan_idleSleep0',
                                                      ...
                                                      ('tt_a_ara_ddl_trashcan_idleAwesome3',
                                                       ...
                                                       0,
                                                       0))}
    ZoneToIdleIntoFightAnims = {ToontownGlobals.ToontropolisPlaza: 'tt_a_ara_ttc_trashcan_idleIntoFight',
