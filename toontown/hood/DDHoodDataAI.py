...
from toontown.classicchars import DistributedFoggyFjordAI
...
class DDHoodDataAI(HoodDataAI.HoodDataAI):
    ...
    def __init__(self, air, zoneId=None):
        hoodId = ToontownGlobals.FoggyFjords
        if zoneId is None:
            zoneId = hoodId
    ...
    def startup(self):
        ...
        self.classicChar = DistributedFoggyFjordAI.DistributedFoggyFjordAI(
            self.air)
