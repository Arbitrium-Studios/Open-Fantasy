...
from toontown.classicchars import DistributedDowntownToontownAI
if __debug__:
    import pdb
...
class GSHoodDataAI(HoodDataAI.HoodDataAI):
    ...
    def __init__(self, air, zoneId=None):
        hoodId = ToontownGlobals.DowntownToontown
        if zoneId is None:
            zoneId = hoodId
    ...
    def startup(self):
        ...
        self.classicChar = DistributedDowntownToontownAI.DistributedDowntownToontownAI(
            self.air)
