...
class GSHood(ToonHood.ToonHood):
    ...
    def __init__(self, parentFSM, doneEvent, dnaStore, hoodId):
        ...
        self.storageDNAFile = '../../user/default/resources/default/phase_6/dna/storage_GS.dna'
        self.holidayStorageDNADict = {HALLOWEEN_PROPS: ['../../user/default/resources/default/phase_6/dna/halloween_props_storage_GS.dna'],
                                      SPOOKY_PROPS: ['../../user/default/resources/default/phase_6/dna/halloween_props_storage_GS.dna'],
                                      CRASHED_LEADERBOARD: ['../../user/default/resources/default/phase_6/dna/crashed_leaderboard_storage_GS.dna']}
