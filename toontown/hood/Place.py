...
class Place(StateData.StateData, FriendsListManager.FriendsListManager):
    ...
    def _getQZState(self):
        if hasattr(base, 'cr') and hasattr(base.cr, 'playGame'):
            if hasattr(
                    base.cr.playGame, 'quietZoneStateData') and base.cr.playGame.quietZoneStateData:
    ...
    def enterWalk(self, teleportIn=0):
        ...
        if base.cr.productName in [
                'DisneyOnline-US', 'ES'] and not base.cr.isPaid() and base.localAvatar.tutorialAck:
    ...
    def enterSit(self):
        ...
        self.accept(f'{base.MOVE_FORWARD}', self.fsm.request, extraArgs=['walk'])
