...
class DistributedLawbotBossGavel(DistributedObject.DistributedObject, FSM.FSM):
    ...
    def __init__(self, cr):
        ...
        self.index = None
        self.avId = 0
        self.modelPath = '../../user/default/resources/default/phase_11/models/lawbotHQ/LB_gavel'
    ...
    def announceGenerate(self):
        ...
        self.gavelSfx = loader.loadSfx('../../user/default/resources/default/phase_11/audio/sfx/LB_gavel.ogg')
