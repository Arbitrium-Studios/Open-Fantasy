...
class DistributedBanquetTable(
    ...
    def loadAssets(self):
        self.tableGroup = loader.loadModel(
            '../../user/default/resources/default/phase_12/models/bossbotHQ/BanquetTableChairs')
        ...
        self.hitBossSfx = loader.loadSfx(
            '../../user/default/resources/default/phase_5/audio/sfx/SA_watercooler_spray_only.ogg')
        self.hitBossSoundInterval = SoundInterval(
            self.hitBossSfx, node=self.boss, volume=1.0)
        self.serveFoodSfx = loader.loadSfx(
            '../../user/default/resources/default/phase_4/audio/sfx/MG_sfx_travel_game_bell_for_trolley.ogg')
    ...
    def prepareForPhaseFour(self):
        if not self.preparedForPhaseFour:
            ...
            self.waterPitcherModel = loader.loadModel(
                '../../user/default/resources/default/phase_12/models/bossbotHQ/tt_m_ara_bhq_seltzerBottle')
