...
class DistributedMoleField(DistributedNodePathEntity,
    ...
    def loadModel(self):
        ...
        self.soundBomb = base.loader.loadSfx(
            '../../user/default/resources/default/phase_12/audio/sfx/Mole_Surprise.ogg')
        self.soundBomb2 = base.loader.loadSfx(
            '../../user/default/resources/default/phase_3.5/audio/dial/AV_pig_howl.ogg')
        self.soundCog = base.loader.loadSfx(
            '../../user/default/resources/default/phase_12/audio/sfx/Mole_Stomp.ogg')
        self.soundUp = base.loader.loadSfx('../../user/default/resources/default/phase_4/audio/sfx/MG_Tag_C.ogg')
    ...
    def __showToonHitByBomb(self, avId, moleIndex, timestamp=0):
        ...
        if avId != localAvatar.doId:
            ...
            def camTask(task, zenith=zenith, flyNode=toon,
                        startCamPos=startCamPos, camOffset=destCamPos - startCamPos):
