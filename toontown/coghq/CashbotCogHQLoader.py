...
class CashbotCogHQLoader(CogHQLoader.CogHQLoader):
    ...
    def __init__(self, hood, parentFSMState, doneEvent):
        ...
        self.cogHQExteriorModelPath = '../../user/default/resources/default/phase_10/models/cogHQ/CashBotShippingStation'
        self.cogHQLobbyModelPath = '../../user/default/resources/default/phase_10/models/cogHQ/VaultLobby'
        self.geom = None
        return
