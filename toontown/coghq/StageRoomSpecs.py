...
CashbotStageConnectorRooms = (
    '../../user/default/resources/default/phase_11/models/lawbotHQ/LB_connector_7cubeL2',
    '../../user/default/resources/default/phase_11/models/lawbotHQ/LB_connector_7cubeLR')
