...
class DistributedButton(DistributedSwitch.DistributedSwitch):
    ...
    def setupSwitch(self):
        model = loader.loadModel('../../user/default/resources/default/phase_9/models/cogHQ/CogDoor_Button')
        if model:
    ...
    def switchOnTrack(self):
        onSfx = base.loader.loadSfx(
            '../../user/default/resources/default/phase_9/audio/sfx/CHQ_FACT_switch_pressed.ogg')
        duration = 0.8
    ...
    def switchCountdownTrack(self):
        ...
        countDownSfx = base.loader.loadSfx(
            '../../user/default/resources/default/phase_9/audio/sfx/CHQ_FACT_switch_depressed.ogg')
        track = Parallel(
    ...
    def switchOffTrack(self):
        offSfx = base.loader.loadSfx(
            '../../user/default/resources/default/phase_9/audio/sfx/CHQ_FACT_switch_popup.ogg')
        duration = 1.0
        halfDur = duration * 0.5
        pos = Vec3(0.0)
        track = Sequence(
