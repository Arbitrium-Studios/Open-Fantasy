...
class FactoryInterior(BattlePlace.BattlePlace):
    ...
    def load(self):
        self.fsm = ClassicFSM.ClassicFSM('FactoryInterior', [State.State('start', self.enterStart, self.exitStart, ['walk', 'teleportIn', 'fallDown']),
            ...
            'stopped', self.enterStopped, self.exitStopped, [
                'walk', 'teleportOut']),
            State.State(
            'sit', self.enterSit, self.exitSit, [
        ...
        self.music = base.loader.loadMusic('../../user/default/resources/default/phase_9/audio/bgm/CHQ_FACT_bg.ogg')
    ...
    def enter(self, requestStatus):
        ...
        self._telemLimiter = TLGatherAllAvs(
            'FactoryInterior', RotationLimitToH)
