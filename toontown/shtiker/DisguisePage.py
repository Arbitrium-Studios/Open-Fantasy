...
class DisguisePage(ShtikerPage.ShtikerPage):
    ...
    def load(self):
        ...
        gui = loader.loadModel('../../user/default/resources/default/phase_9/models/gui/cog_disguises')
        ...
        self.promotionTitle = DirectLabel(
            ...
            geom_pos=(
                ...
                0.1,
                0))
        self.cogName = DirectLabel(parent=self.frame, relief=None, text='', text_font=ToontownGlobals.getSuitFont(
        ), text_scale=TTLocalizer.DPcogName, text_align=TextNode.ACenter, pos=(-0.948, 0, -1.15))
        self.cogLevel = DirectLabel(parent=self.frame, relief=None, text='', text_font=ToontownGlobals.getSuitFont(
        ), text_scale=0.09, text_align=TextNode.ACenter, pos=(-0.91, 0, -1.02))
        ...
        ), text_scale=0.08, text_align=TextNode.ACenter, pos=(-0.91, 0, -0.82))
