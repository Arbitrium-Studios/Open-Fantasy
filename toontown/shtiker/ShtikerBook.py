...
class ShtikerBook(DirectFrame, StateData.StateData):
    ...
    def load(self):
        ...
        self.openSound = base.loader.loadSfx(
            '../../user/default/resources/default/phase_3.5/audio/sfx/GUI_stickerbook_open.ogg')
        self.closeSound = base.loader.loadSfx(
            '../../user/default/resources/default/phase_3.5/audio/sfx/GUI_stickerbook_delete.ogg')
    ...
    def addPageTab(self, page, pageIndex, pageName='Page'):
        ...
        if pageName == TTLocalizer.OptionsPageTitle:
            ...
            iconGeom = iconModels = loader.loadModel(
                '../../user/default/resources/default/phase_3.5/models/gui/filmstrip')
            iconScale = 1.1
            ...
            iconModels = loader.loadModel('../../user/default/resources/default/phase_3.5/models/gui/playingCard')
            ...
            iconModels = loader.loadModel('../../user/default/resources/default/phase_6/models/golf/golf_gui')
