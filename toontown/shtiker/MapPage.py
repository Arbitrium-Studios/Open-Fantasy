...
class MapPage(ShtikerPage.ShtikerPage):
    ...
    def load(self):
        ...
        mapModel = loader.loadModel('../../user/default/resources/default/phase_3.5/models/gui/toontown_map')
        ...
        self.hoodLabel.hide()
        cloudModel = loader.loadModel('../../user/default/resources/default/phase_3.5/models/gui/cloud')
