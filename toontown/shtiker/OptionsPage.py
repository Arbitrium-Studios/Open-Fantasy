...
class OptionsTabPage(DirectFrame):
    ...
    def load(self):
        ...
        self.speedChatStyleText = SpeedChat.SpeedChat(
            ...
            structure=[2000],
            backgroundModelName='../../user/default/resources/default/phase_3/models/gui/ChatPanel',
            guiModelName='../../user/default/resources/default/phase_3.5/models/gui/speedChatGui')
...
class CodesTabPage(DirectFrame):
    ...
    def load(self):
        cdrGui = loader.loadModel(
            '../../user/default/resources/default/phase_3.5/models/gui/tt_m_gui_sbk_codeRedemptionGui')
        ...
        self.successSfx = base.loader.loadSfx(
            '../../user/default/resources/default/phase_3.5/audio/sfx/tt_s_gui_sbk_cdrSuccess.ogg')
        self.failureSfx = base.loader.loadSfx(
            '../../user/default/resources/default/phase_3.5/audio/sfx/tt_s_gui_sbk_cdrFailure.ogg')
        ...
        submitButtonGui = loader.loadModel('../../user/default/resources/default/phase_3/models/gui/quit_button')
