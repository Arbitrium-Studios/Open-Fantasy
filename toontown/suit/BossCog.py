...
class BossCog(Avatar.Avatar):
    ...
    def generateBossCog(self):
        ...
        self.doorA = self.__setupDoor('**/joint_doorFront', 'doorA', self.doorACallback, VBase3(0, 0, 0), VBase3(
            0, 0, -80), CollisionPolygon(Point3(5, -4, 0.32), Point3(0, -4, 0), Point3(0, 4, 0), Point3(5, 4, 0.32)))
        self.doorB = self.__setupDoor('**/joint_doorRear', 'doorB', self.doorBCallback, VBase3(0, 0, 0), VBase3(
            0, 0, 80), CollisionPolygon(Point3(-5, 4, 0.84), Point3(0, 4, 0), Point3(0, -4, 0), Point3(-5, -4, 0.84)))
    ...
    def __rollTreadsInterval(self, object, start=0, duration=0, rate=1):
        ...
        return LerpFunctionInterval(
            rollTexMatrix, fromData=start, toData=start + rate * duration, duration=duration)
