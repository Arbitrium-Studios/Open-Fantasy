...
ModelDict = {'pg': '../../user/default/resources/default/phase_9/models/char/Cog_Goonie',
             'sg': '../../user/default/resources/default/phase_9/models/char/Cog_Goonie'}
...
class Goon(Avatar.Avatar):
    ...
    def scaleRadar(self):
        ...
        model = loader.loadModel('../../user/default/resources/default/phase_9/models/cogHQ/alphaCone2')
