...
class Suit(Avatar.Avatar):
    ...
    def makeRentalSuit(self, suitType, modelRoot=None):
        ...
        if suitType == 's':
            torsoTex = loader.loadTexture(
                'phase_3.5/maps/tt_t_ene_sellbotRental_blazer.png')
            legTex = loader.loadTexture(
                'phase_3.5/maps/tt_t_ene_sellbotRental_leg.png')
            armTex = loader.loadTexture(
                'phase_3.5/maps/tt_t_ene_sellbotRental_sleeve.png')
            handTex = loader.loadTexture(
                'phase_3.5/maps/tt_t_ene_sellbotRental_hand.png')
        else:
