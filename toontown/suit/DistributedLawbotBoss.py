...
class DistributedLawbotBoss(DistributedBossCog.DistributedBossCog, FSM.FSM):
    ...
    def announceGenerate(self):
        ...
        self.piesRestockSfx = loader.loadSfx(
            '../../user/default/resources/default/phase_5/audio/sfx/LB_receive_evidence.ogg')
        self.rampSlideSfx = loader.loadSfx(
            '../../user/default/resources/default/phase_9/audio/sfx/CHQ_VP_ramp_slide.ogg')
        self.evidenceHitSfx = loader.loadSfx(
            '../../user/default/resources/default/phase_11/audio/sfx/LB_evidence_hit.ogg')
        ...
        self.juryMovesSfx = loader.loadSfx(
            '../../user/default/resources/default/phase_11/audio/sfx/LB_jury_moves.ogg')
        self.toonUpSfx = loader.loadSfx('../../user/default/resources/default/phase_11/audio/sfx/LB_toonup.ogg')
        self.strafeSfx = []
        for i in range(10):
            self.strafeSfx.append(
                loader.loadSfx('../../user/default/resources/default/phase_3.5/audio/sfx/SA_shred.ogg'))
    ...
    def __walkSuitToPoint(self, node, fromPos, toPos):
        ...
        return Sequence(Func(node.setPos, fromPos), Func(
            node.headsUp, toPos), node.posInterval(time, toPos))
    ...
    def __makeRollToBattleTwoMovie(self):
        ...
        finalReflectedPodiumPos = Point3(
            ...
            ToontownGlobals.LawbotBossBattleTwoPosHpr[2])
        return Sequence(chatTrack, bossTrack, Func(self.getGeomNode().setH, 0), Parallel(self.podium.posInterval(5.0, finalPodiumPos), self.reflectedPodium.posInterval(5.0, finalReflectedPodiumPos), Func(
            self.stashBoss), self.posInterval(5.0, battlePos), Func(taskMgr.doMethodLater, 0.01, self.unstashBoss, 'unstashBoss')), name=self.uniqueName('BattleTwoMovie'))
    ...
    def __makeRollToBattleThreeMovie(self):
        ...
        return Sequence(chatTrack, bossTrack, Func(
            self.getGeomNode().setH, 0), name=self.uniqueName('BattleTwoMovie'))
    ...
    def loadEnvironment(self):
        ...
        self.geom = loader.loadModel(
            '../../user/default/resources/default/phase_11/models/lawbotHQ/LawbotCourtroom3')
        ...
        self.battleTwoMusic = base.loader.loadMusic(
            '../../user/default/resources/default/phase_11/audio/bgm/LB_juryBG.ogg')
    ...
    def loadScaleNew(self):
        self.scaleNodePath = loader.loadModel('../../user/default/resources/default/phase_11/models/lawbotHQ/scale')
    ...
    def __loadMopaths(self):
        ...
        self.toonsEnterA.loadFile('../../user/default/resources/default/phase_9/paths/bossBattle-toonsEnterA')
        self.toonsEnterA.fFaceForward = 1
        self.toonsEnterA.timeScale = 35
        self.toonsEnterB = Mopath.Mopath()
        self.toonsEnterB.loadFile('../../user/default/resources/default/phase_9/paths/bossBattle-toonsEnterB')
    ...
    def enterRollToBattleTwo(self):
        ...
        seq = Sequence(self.__makeRollToBattleTwoMovie(), Func(
            self.__onToPrepareBattleTwo), name=intervalName)
        seq.start()
            ...
            Func(
                ...
                camera.setHpr, -90, 0, 0), Wait(3), Func(
                    camera.reparentTo, self.witnessToon), Func(
                        camera.setPos, 0, 8, 2), Func(
                            camera.setHpr, 180, 10, 0), Func(
                                self.__doWitnessPrepareBattleThreeChat))
        return movie
