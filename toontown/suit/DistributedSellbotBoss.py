...
class DistributedSellbotBoss(DistributedBossCog.DistributedBossCog, FSM.FSM):
    ...
    def announceGenerate(self):
        ...
        self.cageDoorSfx = loader.loadSfx(
            '../../user/default/resources/default/phase_5/audio/sfx/CHQ_SOS_cage_door.ogg')
        self.cageLandSfx = loader.loadSfx(
            '../../user/default/resources/default/phase_9/audio/sfx/CHQ_SOS_cage_land.ogg')
        self.cageLowerSfx = loader.loadSfx(
            '../../user/default/resources/default/phase_5/audio/sfx/CHQ_SOS_cage_lower.ogg')
        self.piesRestockSfx = loader.loadSfx(
            '../../user/default/resources/default/phase_9/audio/sfx/CHQ_SOS_pies_restock.ogg')
    ...
    def __makeCagedToon(self):
        ...
        touch = CollisionPolygon(Point3(-3.0382, 3.0382, -1), Point3(
            3.0382, 3.0382, -1), Point3(3.0382, -3.0382, -1), Point3(-3.0382, -3.0382, -1))
        touch.setTangible(0)
        ...
        dialogTrack = Track(
            (0, Parallel(
                camera.posHprInterval(
                    8, Point3(-22, -100, 35), Point3(-10, -13, 0), blendType='easeInOut'),
        ...
        seq = Sequence(
            ...
            Parallel(
                self.cage.posInterval(
                    0.5, self.cagePos[5], blendType='easeOut'),
    ...
    def loadEnvironment(self):
        ...
        self.geom = loader.loadModel('../../user/default/resources/default/phase_9/models/cogHQ/BossRoomHQ')
        ...
        elevatorModel = loader.loadModel('../../user/default/resources/default/phase_9/models/cogHQ/cogHQ_elevator')
