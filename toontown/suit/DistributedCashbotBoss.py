...
class DistributedCashbotBoss(DistributedBossCog.DistributedBossCog, FSM.FSM):
    ...
    def loadEnvironment(self):
        ...
        self.midVault = loader.loadModel('../../user/default/resources/default/phase_10/models/cogHQ/MidVault.bam')
        self.endVault = loader.loadModel('../../user/default/resources/default/phase_10/models/cogHQ/EndVault.bam')
        ...
        self.safe = loader.loadModel('../../user/default/resources/default/phase_10/models/cogHQ/CBSafe.bam')
        self.eyes = loader.loadModel(
            '../../user/default/resources/default/phase_10/models/cogHQ/CashBotBossEyes.bam')
        ...
        elevatorModel = loader.loadModel('../../user/default/resources/default/phase_10/models/cogHQ/CFOElevator')
    ...
    def __makeGoonMovieForIntro(self):
        ...
        return Sequence(Func(self.__showFakeGoons, 'Walk'),
                        goonTrack, Func(self.__hideFakeGoons))
        ...
        track = Sequence(
            ...
            Parallel(
                camera.posHprInterval(
                    4, Point3(108, -244, 4), VBase3(211.5, 0, 0)),
                Sequence(
    ...
    def makePrepareBattleThreeMovie(self, delayDeletes, crane, safe):
        ...
        track = Sequence(
            ...
            Func(self.clearChat),
            camera.posHprInterval(1.5, Point3(
                105, -326, 5), Point3(136.3, 0, 0), blendType='easeInOut'),
            Func(
                rToon.setChatAbsolute,
            ...
            Parallel(
                ...
                rToon.posHprInterval(3, Point3(136, -212.9, 0), VBase3(-14, 0, 0),
                                     startPos=Point3(110.8, -292.7, 0), startHpr=VBase3(-14, 0, 0)),
        ...
        return Sequence(Func(camera.reparentTo, self), Func(
    ...
    def makeBossFleeMovie(self):
        ...
        loco = loader.loadModel('../../user/default/resources/default/phase_10/models/cogHQ/CashBotLocomotive')
        car1 = loader.loadModel('../../user/default/resources/default/phase_10/models/cogHQ/CashBotBoxCar')
        car2 = loader.loadModel('../../user/default/resources/default/phase_10/models/cogHQ/CashBotTankCar')
        trainPassingSfx = base.loader.loadSfx(
            '../../user/default/resources/default/phase_10/audio/sfx/CBHQ_TRAIN_pass.ogg')
        boomSfx = loader.loadSfx('../../user/default/resources/default/phase_3.5/audio/sfx/ENC_cogfall_apart.ogg')
        ...
        g = 80.0 / 300.0
        trainTrack = Track(
            (0 * g, loco.posInterval(0.5, Point3(0, -242, 0),
             startPos=Point3(150, -242, 0))),
            (1 * g, car2.posInterval(0.5, Point3(0, -242, 0),
             startPos=Point3(150, -242, 0))),
            (2 * g, car1.posInterval(0.5, Point3(0, -242, 0),
             startPos=Point3(150, -242, 0))),
            (3 * g, car2.posInterval(0.5, Point3(0, -242, 0),
             startPos=Point3(150, -242, 0))),
            (4 * g, car1.posInterval(0.5, Point3(0, -242, 0),
             startPos=Point3(150, -242, 0))),
            (5 * g, car2.posInterval(0.5, Point3(0, -242, 0),
             startPos=Point3(150, -242, 0))),
            (6 * g, car1.posInterval(0.5, Point3(0, -242, 0),
             startPos=Point3(150, -242, 0))),
            (7 * g, car2.posInterval(0.5, Point3(0, -242, 0),
             startPos=Point3(150, -242, 0))),
            (8 * g, car1.posInterval(0.5, Point3(0, -242, 0),
             startPos=Point3(150, -242, 0))),
            (9 * g, car2.posInterval(0.5, Point3(0, -242, 0),
             startPos=Point3(150, -242, 0))),
            (10 * g, car1.posInterval(0.5, Point3(0, -242, 0),
             startPos=Point3(150, -242, 0))),
            (11 * g, car2.posInterval(0.5, Point3(0, -242, 0),
             startPos=Point3(150, -242, 0))),
            (12 * g, car1.posInterval(0.5, Point3(0, -242, 0),
             startPos=Point3(150, -242, 0))),
            (13 * g, car2.posInterval(0.5, Point3(0, -242, 0),
             startPos=Point3(150, -242, 0))),
    ...
    def enterReward(self):
        ...
        victory, camVictory, skipper = MovieToonVictory.doToonVictory(
            1, self.involvedToons, self.toonRewardIds, self.toonRewardDicts, self.deathList, self.rewardPanel, allowGroupShot=0, uberList=self.uberList, noSkip=True)
