...
class DistributedSuitBase(
    ...
    def beginSupaFlyMove(self, pos, moveIn, trackName):
        ...
        if moveIn:
            ...
            return Parallel(lerpPosTrack, shadowTrack, fadeInTrack,
                            animTrack, propTrack, name=self.taskName('trackName'))
        else:
            lerpPosTrack = Sequence(
            ...
            propTrack = Parallel(
                ...
                Sequence(
                    ...
                    Func(
                        self.detachPropeller)))
            return Parallel(ParallelEndTogether(lerpPosTrack, shadowTrack,
                            fadeOutTrack), actInt, propTrack, name=self.taskName('trackName'))
        return
