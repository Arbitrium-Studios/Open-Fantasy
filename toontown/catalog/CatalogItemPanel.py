...
class CatalogItemPanel(DirectFrame):
    ...
    def load(self):
        ...
        if self['item'].needsCustomize() and (typeCode == CatalogItemTypes.WALLPAPER_ITEM or typeCode == CatalogItemTypes.FLOORING_ITEM or typeCode ==
                                              CatalogItemTypes.MOULDING_ITEM or typeCode == CatalogItemTypes.FURNITURE_ITEM or typeCode == CatalogItemTypes.WAINSCOTING_ITEM or typeCode == CatalogItemTypes.TOON_STATUE_ITEM):
        ...
        self.priceLabel = DirectLabel(
            parent=self, relief=None, pos=(
                0, 0, -0.3), scale=priceScale, text=priceStr, text_fg=(
        ...
        soundIcons = loader.loadModel('../../user/default/resources/default/phase_5.5/models/gui/catalogSoundIcons')
        ...
        if emblemPrices:
            if numericBeanPrice:
                ...
                beanModel = loader.loadModel(
                    '../../user/default/resources/default/phase_5.5/models/estate/jellyBean')
