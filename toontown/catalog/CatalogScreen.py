...
NUM_CATALOG_ROWS = 3
NUM_CATALOG_COLS = 2
CatalogPanelCenters = [[Point3(-0.95, 0, 0.91), Point3(-0.275, 0, 0.91)], [Point3(-0.95,
                                                                                  0, 0.275), Point3(-0.275, 0, 0.275)], [Point3(-0.95, 0, -0.4), Point3(-0.275, 0, -0.4)]]
...
class CatalogScreen(DirectFrame):
    ...
    def __init__(self, parent=aspect2d, **kw):
        ...
        guiBack = loader.loadModel(
            '../../user/default/resources/default/phase_5.5/models/gui/package_delivery_panel')
    ...
    def load(self, guiItems, guiButton, guiBack):
        ...
        if len(self.ffList) > 0:
            ...
            self.giftLabel = DirectLabel(
                self.base, relief=None, image=giftFriends, image_scale=(
                    1.15, 1, 1.14), text=' ', text_font=ToontownGlobals.getSignFont(), text_pos=(
                    1.2, -0.97), text_scale=0.07, text_fg=(
        ...
        self.catalogNumber = DirectLabel(
            self.cover, relief=None, scale=0.2, pos=(
                -0.22, 0, -0.33), text='#%d' %
            weekNumber, text_fg=(
        ...
        self.catalogSeries = DirectLabel(
            self.cover, relief=None, scale=(
                0.22, 1, 0.18), pos=(
                -0.76, 0, -0.9), text=TTLocalizer.CatalogSeriesLabel %
            seriesNumber, text_fg=(
                0.9, 0.9, 0.4, 1), text_shadow=(
                    0, 0, 0, 1), text_font=ToontownGlobals.getInterfaceFont())
        ...
        self.pageLabel = DirectLabel(
            self.base, relief=None, pos=(
                -1.33, 0, -0.9), scale=0.06, text=TTLocalizer.CatalogPagePrefix, text_fg=(
                0.95, 0.95, 0, 1), text_shadow=(
    ...
    def loadClarabelle(self):
        ...
        self.clarabelle = Actor.Actor(
            '../../user/default/resources/default/phase_5.5/models/char/Clarabelle-zero', {
                'listen': '../../user/default/resources/default/phase_5.5/models/char/Clarabelle-listens'})
        ...
        switchboard = loader.loadModel('../../user/default/resources/default/phase_5.5/models/estate/switchboard')
    ...
    def setClarabelleChat(self, str, timeout=6):
        ...
        if not self.clarabelleChatBalloon:
            self.clarabelleChatBalloon = loader.loadModel(
                '../../user/default/resources/default/phase_3/models/props/chatbox.bam')
