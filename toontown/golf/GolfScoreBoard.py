...
class GolfScoreBoard:
    ...
    def setup(self):
        ...
        guiModel = loader.loadModel('../../user/default/resources/default/phase_6/models/golf/golf_gui')
        highlight = loader.loadModel('../../user/default/resources/default/phase_6/models/golf/headPanel')
        ...
        self.highlightCur = DirectLabel(parent=self.scoreboard, relief=None, pos=(
            -0.003, 0, 0.038), image=highlight, image_scale=(1.82, 1, 0.135))
