...
class DistributedPhysicsWorld(
    ...
    def clientCommonObject(self, type, commonId, pos,
                           hpr, sizeX, sizeY, moveDistance):
            ...
            for pair in self.odePandaRelationList:
                ...
                if odeBody == cross:
                    ...
                    windmillSfx = loader.loadSfx(
                        '../../user/default/resources/default/phase_6/audio/sfx/Golf_Windmill_Loop.ogg')
            ...
            for pair in self.odePandaRelationList:
                ...
                if odeBody == box:
                    ...
                    moverSfx = loader.loadSfx(
                        '../../user/default/resources/default/phase_6/audio/sfx/Golf_Moving_Barrier.ogg')
