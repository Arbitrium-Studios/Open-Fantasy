...
cricket = loader.loadSfx("phase_8/audio/sfx/Cricket.ogg")
cicada = loader.loadSfx("phase_8/audio/sfx/Cicada.ogg")
rooster = loader.loadSfx("phase_8/audio/sfx/Rooster.ogg")
...
def makeNight():
    ...
    for disc in discs:
        disc.show()
    base.playSfx(cricket, volume=0.3)
    dayMusic.stop()
...
i = Parallel(Sequence(Parallel(LerpColorScaleInterval(render, tSeg, dawnColor),
                      ...
                      Func(base.playSfx, cicada, 0, 1, 0.2),
                      Wait(tSeg),
                      Func(base.playSfx, cricket, 0, 1, 0.2),
                      Wait(tSeg),
                      ),
             )
i.loop()
