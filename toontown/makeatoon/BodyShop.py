...
class BodyShop(StateData.StateData):
    ...
    def load(self):
        ...
        self.parentFrame = DirectFrame(
            relief=DGG.RAISED, pos=(
                ...
                1, 0, 0, 0))
        self.speciesFrame = DirectFrame(parent=self.parentFrame, image=shuffleFrame, image_scale=halfButtonInvertScale, relief=None, pos=(
            0, 0, -0.073), hpr=(0, 0, 0), scale=1.3, frameColor=(1, 1, 1, 1), text='Species', text_scale=0.0625, text_pos=(-0.001, -0.015), text_fg=(1, 1, 1, 1))
        ...
        self.bodyFrame = DirectFrame(parent=self.parentFrame, image=shuffleFrame, image_scale=halfButtonScale, relief=None, pos=(0, 0, -0.5), hpr=(
            0, 0, -2), scale=0.9, frameColor=(1, 1, 1, 1), text=TTLocalizer.BodyShopBody, text_scale=0.0625, text_pos=(-0.001, -0.015), text_fg=(1, 1, 1, 1))
    ...
    def getCurrToonSetting(self):
        return [self.toon.style.head,
                self.toon.style.torso, self.toon.style.legs]
