...
class MakeAToon(StateData.StateData):
    ...
    def __init__(self, parentFSM, avList, doneEvent, index, isPaid):
        ...
        self.fsm = ClassicFSM.ClassicFSM('MakeAToon', [State.State('Init', self.enterInit, self.exitInit, ['GenderShop', 'NameShop']),
                                                       State.State(
            'GenderShop', self.enterGenderShop, self.exitGenderShop, ['BodyShop']),
            State.State(
    ...
    def load(self):
        gui = loader.loadModel('../../user/default/resources/default/phase_3/models/gui/tt_m_gui_mat_mainGui')
        ...
        self.roomDropActor.loadModel('../../user/default/resources/default/phase_3/models/makeatoon/roomAnim_model')
        self.roomDropActor.loadAnims(
            {'drop': '../../user/default/resources/default/phase_3/models/makeatoon/roomAnim_roomDrop'})
        ...
        self.roomSquishActor.loadModel(
            '../../user/default/resources/default/phase_3/models/makeatoon/roomAnim_model')
        self.roomSquishActor.loadAnims(
            {'squish': '../../user/default/resources/default/phase_3/models/makeatoon/roomAnim_roomSquish'})
        ...
        self.propSquishActor.loadAnims(
            {'propSquish': '../../user/default/resources/default/phase_3/models/makeatoon/roomAnim_propSquish'})
        ...
        self.spotlightActor.loadAnims(
            {'spotlightShake': '../../user/default/resources/default/phase_3/models/makeatoon/roomAnim_spotlightShake'})
        ...
        self.room = loader.loadModel(
            '../../user/default/resources/default/phase_3/models/makeatoon/tt_m_ara_mat_room')
        ...
        smokeModel = loader.loadModel(
            '../../user/default/resources/default/phase_3/models/makeatoon/tt_m_ara_mat_smoke')
        ...
        self.music = base.loader.loadMusic(
            '../../user/default/resources/default/phase_3/audio/bgm/create_a_toon.ogg')
        ...
        self.crashSounds.append(base.loader.loadSfx(
            '../../user/default/resources/default/phase_3/audio/sfx/tt_s_ara_mat_crash_boing.ogg'))
        self.crashSounds.append(base.loader.loadSfx(
            '../../user/default/resources/default/phase_3/audio/sfx/tt_s_ara_mat_crash_glassBoing.ogg'))
        self.crashSounds.append(base.loader.loadSfx(
            '../../user/default/resources/default/phase_3/audio/sfx/tt_s_ara_mat_crash_wood.ogg'))
        self.crashSounds.append(base.loader.loadSfx(
            '../../user/default/resources/default/phase_3/audio/sfx/tt_s_ara_mat_crash_woodBoing.ogg'))
        self.crashSounds.append(base.loader.loadSfx(
            '../../user/default/resources/default/phase_3/audio/sfx/tt_s_ara_mat_crash_woodGlass.ogg'))
        return
    ...
    def unload(self):
        ...
        del self.fsm
        self.ignoreAll()
        loader.unloadModel('../../user/default/resources/default/phase_3/models/gui/create_a_toon_gui')
        loader.unloadModel('../../user/default/resources/default/phase_3/models/gui/create_a_toon')
    ...
    def create3DGui(self):
        self.proto = loader.loadModel(
            '../../user/default/resources/default/phase_3/models/makeatoon/tt_m_ara_mat_protoMachine')
