...
lDonaldsDock = "Toontropolis City Shipyard"
lDonaldsDreamland = "Drowsy Slumberland"
lMinniesMelodyland = "The Land Of Music"
lToontownCentral = 'Toontropolis City Plaza'
lToonHQ = 'Toon Headquarters'
lSellbotHQ = 'Sellbot Headquarters'
lGoofySpeedway = 'Toontropolis Stadium'
