...
Donald = 'Donald'
ToontropolisDock = 'ToontropolisDock'
...
lToontownsShipyard = "Toontown's Shipyard"
...
lDowntownToontown = 'Toontown Stadium'
...
ToontownsShipyard = ('to', 'in', lToontownsShipyard)
ToontownPlaza = ('to', 'in', lToontownPlaza)
TundraWonderland = ('to', 'in', lTundraWonderland)
TheLandOfMusic = ('to', 'in', lTheLandOfMusic)
FloweringGrove = ('to', 'in', lFloweringGrove)
AcornAcres = ('to', 'in', lAcornAcres)
FunnyFarm = ('to the', 'in the', 'Funny Farm')
DowntownToontown = ('to', 'in', lDowntownToontown)
...
QuestDialogDict = {160: {GREETING: '',
                   ...
                   1045: {QUEST: 'Thank you so much!\x07Before long I will have the entire collection and can reopen my restaurant.\x07Oh, I have a note here for you - something about teleport access?\x07It says thanks for helping my friend and to deliver this to Toon Headquarters.\x07Well, thanks indeed - bye!',
                          LEAVING: '',
                          COMPLETE: 'Ah, yes, says here you have been a great help to some of the fine folks out on Loopy Lane.\x07Says you need teleport access to ' + lToontownPlaza + '.\x07Well, consider it done.\x07Now you can teleport back to the playground from almost anywhere in Toontown.\x07Just open your map and click on ' + lToontownPlaza + '.'},
                   ...
                   1055: {QUEST: "Yowza!  I can't find the tires to this here clown car anywhere!\x07Do ya think you could help me out?\x07I think Loopy Bob may have tossed them in the pond in the " + lToontownPlaza + ' playground.\x07If you stand on one of the docks there you can try and fish out the tires for me.',
                          GREETING: 'Woohoo!',
                          LEAVING: '',
                   ...
                   1061: {QUEST: "Great - thanks for the ink!\x07You know what, maybe if you cleared away some of those Pencil Pushers...\x07I wouldn't run out of ink again so quickly.\x07Defeat 6 Pencil Pushers in " + lToontownPlaza + ' for your reward.',
                          LEAVING: '',
                          COMPLETE: 'Thanks!  Let me reward you for your help.',
                          INCOMPLETE_PROGRESS: 'I just saw some more Pencil Pushers.'},
                   1062: {QUEST: "Great - thanks for the ink!\x07You know what, maybe if you cleared away some of those Bloodsuckers...\x07I wouldn't run out of ink again so quickly.\x07Defeat 6 Bloodsuckers in " + lToontownPlaza + ' for your reward.',
                          LEAVING: '',
                          COMPLETE: 'Thanks!  Let me reward you for your help.',
                   ...
                   1067: {QUEST: "That's it, all right!\x07Hey, the address is smudged...\x07All I can read is that it's for a Dr. - the rest is all blurry.\x07Maybe it's for _toNpcName_?  Could you take it to him?_where_",
                          LEAVING: ''},
                   1068: {QUEST: "I wasn't expecting a package.  Maybe it's for Dr. I.M. Euphoric?\x07My assistant was going over there today anyway, so I'll have him check for you.\x07In the meantime, would you mind getting rid of some of the Cogs on my street?\x07Defeat 10 Cogs in " + lToontownPlaza + '.',
                          LEAVING: '',
...
MickeyChatter = (['Welcome to ' + lToontownPlaza + '.', 'Hi, my name is ' + Mickey + ". What's yours?"], ['Hey, have you seen ' + Donald + '?',
                                                                                                            "I'm going to go watch the fog roll in at " + lToontownsShipyard + '.',
                                                                                                            ...
                                                                                                            'I hear ' + Daisy + ' has planted some new flowers in her garden.'], ["I'm going to MelodyLand to see " + Minnie + '!',
                                                                                                                                                                                  ...
                                                                                                                                                                                  "I think I'll go swimming at " + lToontownsShipyard + '.',
...
WinterMickeyDChatter = (["Hi, I'm Merry Mickey!",
                         ...
                         'Happy Winter Holiday, %'], ['Golly, these halls sure are decked!',
                                                      ...
                                                      "I think I'll trade my gloves for mittens!"], ['Have a happy Winter Holiday!',
                                                                                                     ...
                                                                                                     'Shucks, sorry you have to go. So long!',
                                                                                                     "I'm going caroling with Minnie!"])
VampireMickeyChatter = (['Welcome to ' + lToontownPlaza + '.',
...
MinnieChatter = (['Welcome to Melodyland.', 'Hi, my name is ' + Minnie + ". What's yours?"], ['The hills are alive with the sound of music!',
                                                                                              ...
                                                                                              "I heard it's foggy at the " + lToontownsShipyard + '.',
...
DaisyChatter = (['Welcome to my garden!', "Hello, I'm " + Daisy + ". What's your name?", "It's so nice to see you %!"], ['My prize winning flower is at the center of the garden maze.',
                                                                                                                         ...
                                                                                                                         'There are far too many ' + Cogs + ' near ' + lToontownsShipyard + '.',
...
DowntownToontownChatter = (['Welcome to ' + lDowntownToontown + '.', 'Hi, my name is ' + Goofy + ". What's yours?", "Gawrsh, it's nice to see you %!"], ['Boy, I saw a terrific race earlier.',
...
DonaldChatter = (['Welcome to Dreamland.', "Hi, my name is %s. What's yours?" % Donald], ['Sometimes this place gives me the creeps.',
                                                                                          ...
                                                                                          "I think I'll go fishing this afternoon.",
                                                                                          'Wow, there are lots of ' + Cogs + ' at ' + lToontownsShipyard + '.',
                                                                                          "Hey, didn't I take you on a boat ride at " + lToontownsShipyard + '?',
                                                                                          "I haven't seen " + Daisy + ' all day.',
                                                                                          'I hear ' + Daisy + ' has planted some new flowers in her garden.',
...
AFDaisyChatter = (["Happy April Toons' Week!", "Happy April Toons' Week, %!"], ['Welcome to ' + lToontownPlaza + "! I'm " + Mickey + ' Mouse!',
...
AFDowntownToontownChatter = (["Happy April Toons' Week!", "Happy April Toons' Week, %!"], ["Welcome to Dreamland! I'm " + Donald + '!',
...
AFToontropolisDockChatter = (["Happy April Toons' Week!", "Happy April Toons' Week, %!"], ["Everybody gets April Toons' Week off but me!",
...
CLDowntownToontownChatter = (['Welcome to ' + lDowntownToontown + '.',
...
GPDowntownToontownChatter = (['Welcome to ' + lDowntownToontown + '.',
...
TwoDGameInstructions = 'Escape from the ' + Cog + ' den as soon as you can. Use movement keys to run/jump and Ctrl Key to squirt a ' + \
...
QuestScript140_1 = 'Good job finding the trolley!\x07By the way, I have this friend, Librarian Larry, who is quite a book worm.\x07I picked this book up for him last time I was over in ' + \
    lToontownsShipyard + '.\x07Could you take it over to him, he is usually in the Library.'
...
TipDict = {TIP_NONE: ('',),
           ...
           TIP_COGHQ: ('You must complete your Sellbot Disguise before visiting the V.P.',
                       ...
                       "Earn Cashbot disguise suit parts as rewards for completing ToonTasks in Twilight Slumberland.",
           ...
           TIP_GOLF: ('Press the Tab key to see a top view of the golf course.', 'Press the Up movement key to point yourself towards the golf hole.', 'Swinging the club is just like throwing a pie.')}
...
HolidayNamesInCalendar = {1: ('Summer Fireworks', 'Celebrate Summer with a fireworks show every hour in each playground!'),
                          ...
                          105: ('Toons go GREEN!', 'Toons make a green scene at Green Bean Jeans on Oak Street in the Flowering Grove!')}
