...
commitmantst: Literal['kptmptest - removable'] = 'kptmptest - removable'
InterfaceFont: str = 'phase_3/models/fonts/ImpressBT.ttf'
ToonFont: str = 'phase_3/models/fonts/ImpressBT.ttf'
SuitFont: str = 'phase_3/models/fonts/vtRemingtonPortable.ttf'
SignFont: str = 'phase_3/models/fonts/MickeyFont'
MinnieFont: str = 'phase_3/models/fonts/MinnieFont'
FancyFont: str = 'phase_3/models/fonts/Comedy'
NametagFonts: tuple[str, ...] = ('phase_3/models/fonts/AnimGothic',
...
NametagFontNames: tuple[str, ...] = ('Member',
                                     'Shivering',
                                     'Wonky',
                                     'Fancy',
                                     'Silly',
                                     ...
                                     'Boardwalk',
                                     'Western')
NametagLabel: Literal[' Nametag'] = ' Nametag'
UnpaidNameTag: str = 'Basic'
GM_NAMES: tuple[str, ...] = ('TOON COUNCIL',
                             'TOON TROOPER',
                             'RESISTANCE RANGER',
                             'GC')
BuildingNametagFont: str = 'phase_3/models/fonts/MickeyFont'
...
Mickey: Literal['Mickey'] = 'Mickey'
VampireMickey: Literal['VampireMickey'] = 'VampireMickey'
Minnie: Literal['Minnie'] = 'Minnie'
WitchMinnie: Literal['WitchMinnie'] = 'WitchMinnie'
Donald = 'Donald'
FrankenDonald = 'FrankenDonald'
pFoggyFjord = 'FoggyFjord' # p = plain
...
FloweringGrove = ('to the', 'in the', lFloweringGrove)
...
lNext = 'Next'
lQuit = 'Quit'
lYes: Literal['Yes'] = 'Yes'
lNo: Literal['No'] = 'No'
sleep_auto_reply: str = '%s is sleeping right now'
lHQOfficerF: Literal['HQ Officer'] = 'HQ Officer'
lHQOfficerM: Literal['HQ Officer'] = 'HQ Officer'
MickeyMouse: Literal['Mickey Mouse'] = 'Mickey Mouse'
AIStartDefaultDistrict: str = 'Sillyville'
Cog = 'Cog'
Cogs = 'Cogs'
ACog = 'a Cog'
TheCogs = 'The Cogs'
...
Period: Literal['.'] = '.'
Laff: Literal['Laff'] = 'Laff'
QuestInLocationString: Literal[' %(inPhrase)s %(location)s'] = ' %(inPhrase)s %(location)s'
QuestsDefaultGreeting: tuple[str, ...] = ('Hello, _avName_!',
                                          'Hi, _avName_!',
                                          'Hey there, _avName_!',
                                          'Say there, _avName_!',
                                          'Welcome, _avName_!',
                                          ...
                                          'Greetings _avName_!')
QuestsDefaultIncomplete: tuple[str, ...] = ("How's that task coming, _avName_?",
...
QuestsDefaultIncompleteProgress: tuple[str, ...] = (
...
QuestsDefaultIncompleteWrongNPC: tuple[str, ...] = (
...
QuestsDefaultLeaving: tuple[str, ...] = ('Bye!',
                                         ...
                                         'See you later!')
QuestsDefaultReject: tuple[str, ...] = ('Hello.',
                                        'Can I help you?',
                                        'How are you?',
                                        'Hello there.',
...
QuestsDefaultTierNotDone: tuple[str, ...] = (
...
PetTrickStrings = {0: 'Jump',
                   ...
                   5: 'Dance',
                   6: 'Speak'}
PetMoodAdjectives: dict[str, str] = {'neutral': 'neutral',
                                     'hunger': 'hungry',
                                     'boredom': 'bored',
                                     'excitement': 'excited',
                                     'sadness': 'sad',
...
SpokenMoods: dict[str, str | list[str]] = {'neutral': 'neutral',
...
DialogQuestion: Literal['?'] = '?'
FriendsListLabel = 'Friends'
TeleportPanelOK: Literal['OK'] = lOK
...
ToonHealJokes: list[list[str]] = [['What goes TICK-TICK-TICK-WOOF?', 'A watchdog!'],
...
MovieHealLaughterMisses: tuple[str, ...] = ('hmm',
                                            'heh',
                                            'ha',
                                            'harr harr')
MovieHealLaughterHits1: tuple[str, ...] = ('Ha Ha Ha',
                                           'Hee Hee',
                                           'Tee Hee',
                                           'Ha Ha')
MovieHealLaughterHits2: tuple[str, ...] = ('BWAH HAH HAH!', 'HO HO HO!', 'HA HA HA!')
...
SuitFaceoffDefaultTaunts: list[str] = ['Boo!']
SuitAttackDefaultTaunts: list[str] = ['Take that!', 'Take a memo on this!']
SuitAttackNames: dict[str, str] = {'Audit': 'Audit!',
                                   'Bite': 'Bite!',
                                   ...
                                   'WriteOff': 'Write Off!',
                                   'WriteUp': 'Write Up!'}
SuitAttackTaunts: dict[str, list[str]] = {'Audit': ["I believe your books don't balance.",
                                          ...
                                          'WriteUp': ['That is a severe offense.',
                                                      ...
                                                      "Oh, no you didn't!",
                                                      "You'll find this very up-\x04setting.",
                                                      'However will you make this up?',
...
KnockKnockJokes: list[list[str]] = [['Who', "Bad echo in here, isn't there?"],
...
MickeyChatter = (['Welcome to ' + lToontownCentral + '.', 'Hi, my name is ' + Mickey + ". What's yours?"], ['Hey, have you seen ' + Donald + '?',
                                                                                                            "I'm going to go watch the fog roll in at " + lFoggyFjord + '.',
                                                                                                            ...
                                                                                                            'I hear ' + Daisy + ' has planted some new flowers in her garden.'], ["I'm going to MelodyLand to see " + Minnie + '!',
                                                                                                                                                                                  ...
                                                                                                                                                                                  "I think I'll go swimming at " + lFoggyFjord + '.',
...
MinnieChatter = (['Welcome to Melodyland.', 'Hi, my name is ' + Minnie + ". What's yours?"], ['The hills are alive with the sound of music!',
                                                                                              ...
                                                                                              "I heard it's foggy at the " + lFoggyFjord + '.',
...
DaisyChatter = (['Welcome to my garden!', "Hello, I'm " + Daisy + ". What's your name?", "It's so nice to see you %!"], ['My prize winning flower is at the center of the garden maze.',
                                                                                                                         ...
                                                                                                                         'There are far too many ' + Cogs + ' near ' + lFoggyFjord + '.',
...
DonaldChatter = (['Welcome to Dreamland.', "Hi, my name is %s. What's yours?" % Donald], ['Sometimes this place gives me the creeps.',
                                                                                          ...
                                                                                          "I think I'll go fishing this afternoon.",
                                                                                          'Wow, there are lots of ' + Cogs + ' at ' + lFoggyFjord + '.',
                                                                                          "Hey, didn't I take you on a boat ride at " + lFoggyFjord + '?',
                                                                                          "I haven't seen " + Daisy + ' all day.',
                                                                                          'I hear ' + Daisy + ' has planted some new flowers in her garden.',
...
CalendarPartyFinished: Literal["It's over..."] = "It's over..."
CalendarPartyCancelled = 'Cancelled.'
CalendarPartyNeverStarted = 'Never Started.'
NPCFriendPanelRemaining: Literal['%d Remaining'] = '%d Remaining'
MapPageTitle: Literal['Map'] = 'Map'
...
NumToColor = ['White',
              ...
              'Plum',
              'Black']
AnimalToSpecies: dict[str, str] = {'dog': 'Dog',
                                   'cat': 'Cat',
                                   'mouse': 'Mouse',
                                   'horse': 'Horse',
                                   'rabbit': 'Rabbit',
...
QuestScript140_1 = 'Good job finding the trolley!\x07By the way, I have this friend, Librarian Larry, who is quite a book worm.\x07I picked this book up for him last time I was over in ' + \
    lFoggyFjord + '.\x07Could you take it over to him, he is usually in the Library.'
...
CagedToonBattleThree: dict[int, str] = {10: 'Nice jump, %(toon)s.  Here are some pies!',
...
HatStylesDescriptions: dict[str, str] = {'hbb1': 'Green Baseball Cap',
...
NPCToonNames: dict[int, str] = {20000: 'Tutorial Tom',
                                999: 'Toon Tailor',
                                1000: lToonHQ,
                                20001: Flippy,
                                2001: Flippy,
                                ...
                                7008: 'Ima Cagedtoon',
                                7009: 'Jimmy Thelock'}
zone2TitleDict: dict[int, tuple[str, str]] = {2513: ('Toon Hall', ''),
                                              2514: ('Toontown Bank', ''),
...
TrunkDeleteGlasses: Literal['Delete\nglasses'] = 'Delete\nglasses'
...
TIP_KARTING = 6
TIP_GOLF = 7
TipTitle: Literal['TOON TIP:'] = 'TOON TIP:'
TipDict: dict[int, tuple[str, ...]] = {TIP_NONE: ('',),
...
FishGenusNames: dict[int, str] = {0: 'Balloon Fish',
                                  ...
                                  34: 'Devil Ray'}
FishSpeciesNames: dict[int, tuple[str, ...]] = {0: ('Balloon Fish',
...
WateringCanNameDict = {0: 'Small',
                       ...
                       2: 'Large',
                       3: 'Huge'}
GardeningPlant: Literal['Plant'] = 'Plant'
GardeningWater: Literal['Water'] = 'Water'
...
GolfHoleNames: dict[int, str] = {0: 'Whole In Won',
                                 1: 'No Putts About It',
                                 2: 'Down The Hatch',
                                 3: 'Seeing Green',
                                 4: 'Hot Links',
...
GolfHole = 'Hole'
GolfTotal = 'Total'
GolfExitCourse: Literal['Exit Course'] = 'Exit Course'
GolfUnknownPlayer = '???'
GolfPageTitle = 'Golf'
...
Months = {1: 'JANUARY',
          ...
          11: 'NOVEMBER',
          12: 'DECEMBER'}
DayNames: tuple[Literal['Monday'], Literal['Tuesday'], Literal['Wednesday'], Literal['Thursday'], Literal['Friday'], Literal['Saturday'], Literal['Sunday']] = ('Monday',
                                                                                                                                                                'Tuesday',
                                                                                                                                                                'Wednesday',
                                                                                                                                                                'Thursday',
                                                                                                                                                                'Friday',
                                                                                                                                                                'Saturday',
                                                                                                                                                                'Sunday')
DayNamesAbbrev: tuple[Literal['MON'], Literal['TUE'], Literal['WED'], Literal['THU'], Literal['FRI'], Literal['SAT'], Literal['SUN']] = ('MON',
                                                                                                                                         'TUE',
                                                                                                                                         'WED',
                                                                                                                                         'THU',
                                                                                                                                         'FRI',
