...
class ToonBase(OTPBase.OTPBase):
    ...
    def initNametagGlobals(self):
        arrow = loader.loadModel('../../user/default/resources/default/phase_3/models/props/arrow')
        card = loader.loadModel('../../user/default/resources/default/phase_3/models/props/panel')
        speech3d = ChatBalloon(loader.loadModel(
            '../../user/default/resources/default/phase_3/models/props/chatbox').node())
        thought3d = ChatBalloon(loader.loadModel(
            '../../user/default/resources/default/phase_3/models/props/chatbox_thought_cutout').node())
        speech2d = ChatBalloon(loader.loadModel(
            '../../user/default/resources/default/phase_3/models/props/chatbox_noarrow').node())
        chatButtonGui = loader.loadModel('../../user/default/resources/default/phase_3/models/gui/chat_button_gui')
