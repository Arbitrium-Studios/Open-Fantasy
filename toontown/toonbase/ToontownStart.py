...
backgroundNode = tempLoader.loadSync(
    Filename('../../user/default/resources/default/phase_3/models/gui/loading-background'))
...
DirectGuiGlobals.setDefaultRolloverSound(
    base.loader.loadSfx('../../user/default/resources/default/phase_3/audio/sfx/GUI_rollover.ogg'))
DirectGuiGlobals.setDefaultClickSound(base.loader.loadSfx(
    '../../user/default/resources/default/phase_3/audio/sfx/GUI_create_toon_fwd.ogg'))
DirectGuiGlobals.setDefaultDialogGeom(
    loader.loadModel('../../user/default/resources/default/phase_3/models/gui/dialog_box_gui'))
from . import TTLocalizer
from otp.otpbase import OTPGlobals
OTPGlobals.setDefaultProductPrefix(TTLocalizer.ProductPrefix)
if base.musicManagerIsValid:
    music = base.musicManager.getSound('../../user/default/resources/default/phase_3/audio/bgm/tt_theme.ogg')
    if music:
        music.setLoop(1)
        music.setVolume(0.9)
        music.play()
    ...
    DirectGuiGlobals.setDefaultClickSound(
        base.loader.loadSfx('../../user/default/resources/default/phase_3/audio/sfx/GUI_create_toon_fwd.ogg'))
else:
    music = None
