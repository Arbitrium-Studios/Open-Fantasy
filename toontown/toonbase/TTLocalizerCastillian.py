...
SuitAttackTaunts = {
    ...
    'Legalese':["Debes cejar en tu empeño.",
                ...
                "Las opiniones expresadas en este ataque no coinciden con las de Disney's Toontown Online.",
...
"""
CONTRATO DE REGISTRO DE Disney's Toontown Online DE DISNEY

Bienvenido/a a Disney's Toontown Online de Disney (en lo sucesivo, el "Servicio"). LE ROGAMOS QUE LEA ATENTAMENTE ESTE CONTRATO (EN LO SUCESIVO, EL "CONTRATO") ANTES DE UTILIZAR ESTE SERVICIO. Este Servicio es propiedad de Disney Online, el cual se encarga también de su explotación (en la presente, referido como "Disney", "nosotros" o cualquier forma de la primera persona del plural).
""","""
...
""","""
Además, Disney rechaza cualquier responsabilidad relativa a la exactitud, el contenido o la disponibilidad de la información que aparece en los sitios web a los que se acceda a través de Disney's Toontown Online de Disney de terceros que no estén asociados con Disney. En Disney le aconsejamos que sea precavido cuando navegue por el Internet, ya se encuentre, utilizando nuestro servicio o el de cualquier otra persona o empresa. Dado que en ocasiones algunos sitios utilizan los resultados de búsquedas automatizadas o bien conducen a sitios web que contienen información que puede ser considerada ofensiva o inadecuada, Disney no se responsabilizará por la exactitud ni por el cumplimiento de los derechos de copyright, legalidad o decencia del material en los sitios Web de terceros, y el socio, por la presente, nos exime de cualquier reclamación contra nosotros en relación con dichos sitios web. Disney no podrá garantizarle que estará satisfecho con los productos o servicios que contrate en un sitio Web de terceros conectado a Disney's Toontown Online de Disney, ya que los canales de otros establecimientos son propiedad de otros minoristas que los explotan.
""","""
