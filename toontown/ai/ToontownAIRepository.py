...
class ToontownAIRepository(ToontownInternalRepository):
    ...
    def genDNAFileName(self, zoneId):
        ...
        return 'user/default/resources/default/phase_%s/dna/%s_%s.dna' % (phase, hood, canonicalZoneId)

    def lookupDNAFileName(self, dnaFileName):
        searchPath = DSearchPath()
        searchPath.appendDirectory(Filename('user/default/resources/default/phase_3.5/dna'))
        searchPath.appendDirectory(Filename('user/default/resources/default/phase_4/dna'))
        searchPath.appendDirectory(Filename('user/default/resources/default/phase_5/dna'))
        searchPath.appendDirectory(Filename('user/default/resources/default/phase_5.5/dna'))
        searchPath.appendDirectory(Filename('user/default/resources/default/phase_6/dna'))
        searchPath.appendDirectory(Filename('user/default/resources/default/phase_8/dna'))
        searchPath.appendDirectory(Filename('user/default/resources/default/phase_9/dna'))
        searchPath.appendDirectory(Filename('user/default/resources/default/phase_10/dna'))
        searchPath.appendDirectory(Filename('user/default/resources/default/phase_11/dna'))
        searchPath.appendDirectory(Filename('user/default/resources/default/phase_12/dna'))
        searchPath.appendDirectory(Filename('user/default/resources/default/phase_13/dna'))
