...
class DistributedDowntownToontown(DistributedCCharBase.DistributedCCharBase):
    notify = DirectNotifyGlobal.directNotify.newCategory(
        'DistributedDowntownToontown')
    ...
    def delete(self):
        try:
            self.DistributedDowntownToontown_deleted
        except BaseException:
            del self.fsm
            self.DistributedDowntownToontown_deleted = 1
