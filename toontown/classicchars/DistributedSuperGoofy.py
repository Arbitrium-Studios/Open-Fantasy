...
from toontown.classicchars import DistributedDowntownToontropolis
...
class DistributedSuperGoofy(DistributedDowntownToontropolis.DistributedDowntownToontropolis):
