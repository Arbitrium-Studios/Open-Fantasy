...
class DistributedToontropolisStadiumAI(DistributedCCharBaseAI.DistributedCCharBaseAI):

    notify = DirectNotifyGlobal.directNotify.newCategory("DistributedToontropolisStadiumAI")
